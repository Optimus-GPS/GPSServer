			...
			while ($row = mysqli_fetch_assoc($resultado)) {
				...
				if($loc_ws){
					...
					switch ($ws_name) {
						...
						case "WALMART":
							//Array,User,Passw
							envioWalmart($loc,$ws_credentials[0],$ws_credentials[1],$ws_credentials[2],$ws_credentials[3],$loc_ws['plate_number']);
						case "ALTOTRACK":
						...
						case "SUKARNE":
							...
							envioSukarne($loc,$ws_credentials[0],$ws_credentials[1],$temp_value,$ws_credentials[2],$loc_ws['economico'],$loc_ws['plate_number']);					
							$ws_id = 3;
							break;
						case "RCONFIABLE":
							...
							break;
						case "GUDA":
							fwrite($file, print_r("Entro GUDA******\n",true));
							$resp = envioGuda1($loc,$ws_credentials[0],$ws_credentials[1],$loc_ws['plate_number']);
