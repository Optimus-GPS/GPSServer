					...
					<div class="container last">
						<div class="row2">
							...
							<?}else{?>
								...
								<div class="width1"></div>							
								<div class="width55">
								<input id="cmd_gprs_cmd" class="inputbox" type="password" value="" maxlength="256">
								</div>
							<? }?>
					...
					<div class="container last">
						<div class="row2">
							...
							<?}else{?>
								<div class="width20"><? echo $la['COMMAND'];?></div>					
								<div class="width65">
								<input id="cmd_sms_cmd" class="inputbox" type="password" value="" maxlength="256">
								</div>
							<? }?>
			...
			<div class="container">
				...
				<div class="row2">
					...
					<div class="width65">
						...
						<?}else{?>
							<input id="dialog_cmd_schedule_cmd_cmd" class="inputbox" type="password" value="" maxlength="256">
						<?}?>
					</div>
				</div>
			</div>
