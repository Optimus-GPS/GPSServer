			...
			<div class="container last">
				...
				<div class="row2">
					<div style="height: 305px; overflow-y: scroll;">
						...
						<div class="row"><? echo $la['VAR_TEMPLATE_VAL_DIFF']; ?></div>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="row2">
						...
						<div class="width50">
							<input id="dialog_settings_object_sensor_formula" class="inputbox" type="text" value="" maxlength="800" placeholder="(X+1)/2*3"/>
						</div>
					</div>
					<div class="row2">
