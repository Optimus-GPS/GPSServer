...
function sharePositionOpen() {
	$("#dialog_share_position").dialog("open")
}
...
function sharePositionProperties(e) {
	...
	default:
		...
		$.ajax({
			...
			cache: !1,
			success: function (e) {
				document.getElementById("dialog_share_position_active").checked = strToBoolean(e.active),
				document.getElementById("dialog_share_position_name").value = e.name,
				document.getElementById("dialog_share_position_email").value = e.email,
				document.getElementById("dialog_share_position_phone").value = e.phone,
				document.getElementById("dialog_share_position_object_list").value = e.imei,
				$("#dialog_share_position_object_list").multipleSelect("refresh");
				var t = strToBoolean(e.expire);
				document.getElementById("dialog_share_position_expire").checked = t,
				document.getElementById("dialog_share_position_expire_dt").value = 1 == t ? e.expire_dt: "",
				document.getElementById("dialog_share_position_send_email").checked = !1,
				document.getElementById("dialog_share_position_send_sms").checked = !1,
				shareData.share_position_su = e.su,
				"" == shareData.share_position_su && (shareData.share_position_su = sharePositionGenerateSU()),
				document.getElementById("dialog_share_position_su").value = gsValues.url_root + "/index.php?su=" + shareData.share_position_su,
				document.getElementById("dialog_share_position_su_mobile").value = gsValues.url_root + "/index.php?su=" + shareData.share_position_su + "&m=true",
				sharePositionCheck()
			}
		}),
	...
	case "add":
		...
		$("#dialog_share_position_object_list option:selected").removeAttr("selected"),
		$("#dialog_share_position_object_list").multipleSelect("refresh"),
		...
		document.getElementById("dialog_share_position_send_email").checked = !0,
		document.getElementById("dialog_share_position_send_sms").checked = !0,
	...
	case "save":
		...
		l = document.getElementById("dialog_share_position_object_list").value,
		...
		_ = document.getElementById("dialog_share_position_send_email").checked,
		c = document.getElementById("dialog_share_position_send_sms").checked;
...
function dashboardResize() {
	...
	document.getElementById("dialog_dashboard_objects").style.height = dashboardData.container_height + "px",
	document.getElementById("dialog_dashboard_events").style.height = dashboardData.container_height + "px",
	null != document.getElementById("dialog_dashboard_tasks") && (document.getElementById("dialog_dashboard_tasks").style.height = dashboardData.container_height + "px"),
	null != document.getElementById("dialog_dashboard_maintenance") && (document.getElementById("dialog_dashboard_maintenance").style.height = dashboardData.container_height + "px"),
	document.getElementById("dialog_dashboard_odometer").style.height = dashboardData.container_height + "px",
	document.getElementById("dialog_dashboard_mileage").style.height = dashboardData.container_height + "px",
	null != document.getElementById("dashboard_objects_graph_plot") && (document.getElementById("dashboard_objects_graph_plot").style.height = dashboardData.container_height - 30 - 20 + "px"),
	null != document.getElementById("dashboard_objects_text") && (document.getElementById("dashboard_objects_text").style.height = dashboardData.container_height - 30 - 20 + "px"),
	null != document.getElementById("dashboard_events_graph_plot") && (document.getElementById("dashboard_events_graph_plot").style.height = dashboardData.container_height - 30 - 20 + "px"),
	null != document.getElementById("dashboard_events_text") && (document.getElementById("dashboard_events_text").style.height = dashboardData.container_height - 30 - 20 + "px"),
	null != document.getElementById("dashboard_maintenance_graph_plot") && (document.getElementById("dashboard_maintenance_graph_plot").style.height = dashboardData.container_height - 30 - 20 + "px"),
	null != document.getElementById("dashboard_maintenance_text") && (document.getElementById("dashboard_maintenance_text").style.height = dashboardData.container_height - 30 - 20 + "px"),
	null != document.getElementById("dashboard_tasks_graph_plot") && (document.getElementById("dashboard_tasks_graph_plot").style.height = dashboardData.container_height - 30 - 20 + "px"),
	null != document.getElementById("dashboard_tasks_text") && (document.getElementById("dashboard_tasks_text").style.height = dashboardData.container_height - 30 - 20 + "px"),
	null != document.getElementById("dashboard_odometer_graph_plot") && (document.getElementById("dashboard_odometer_graph_plot").style.height = dashboardData.container_height - 30 - 20 + "px"),
	null != document.getElementById("dashboard_odometer_text") && (document.getElementById("dashboard_odometer_text").style.height = dashboardData.container_height - 30 - 20 + "px"),
	null != document.getElementById("dashboard_mileage_graph_plot") && (document.getElementById("dashboard_mileage_graph_plot").style.height = dashboardData.container_height - 30 - 20 + "px"),
	null != document.getElementById("dashboard_mileage_text") && (document.getElementById("dashboard_mileage_text").style.height = dashboardData.container_height - 30 - 20 + "px")
}
...
function dashboardInitObjectsSetResult(e) {
	dashboardData.objects_result = e,
...
function dashboardInitObjects() {
	if (Object.keys(objectsData).length > 0) {
		...
		d += '<div class="dashboard-container-header-icon"><span class="icon-objects"></span></div>',
		d += '<div class="dashboard-container-header-title">' + la.OBJECTS + "</div>",
		d += '<div class="dashboard-container-header-menu"><a href="#" id="dashboard_objects_action_menu_button"><span class="icon-action2"></span></a></div></div>',
		d += '<div id="dashboard_objects_graph_plot"></div>',
		document.getElementById("dialog_dashboard_objects").innerHTML = d,
		document.getElementById("dashboard_objects_graph_plot").style.height = dashboardData.container_height - 30 - 20 + "px";
		...
		d += '<div class="dashboard-container-header-title">' + la.OBJECTS + "</div>",
		d += '<div class="dashboard-container-header-menu"><a href="#" id="dashboard_objects_action_menu_button"><span class="icon-action2"></span></a></div></div>',
		d += '<div id="dashboard_objects_text" class="dashboard-container-text">' + la.NO_DATA_HAS_BEEN_COLLECTED_YET + "</div>",
		document.getElementById("dialog_dashboard_objects").innerHTML = d,
		document.getElementById("dashboard_objects_text").style.height = dashboardData.container_height - 30 - 20 + "px"
	}
	$("#dashboard_objects_action_menu_button").click(function () {
		return $("#dashboard_events_action_menu").hide(),
...
function dashboardInitEvents() {
	...
	else if ("this_week" == dashboardData.events_period) e = moment().isoWeekday(1).format("YYYY-MM-DD") + " 00:00:00",
	t = moment().add("days", 1).format("YYYY-MM-DD") + " 00:00:00";
	else if ("this_month" == dashboardData.events_period) e = moment().startOf("month").format("YYYY-MM-DD") + " 00:00:00",
	t = moment().add("days", 1).format("YYYY-MM-DD") + " 00:00:00";
	var a = {
	...
	$.ajax({
		...
		success: function (e) {
			if (Object.keys(e).length > 0) {
				...
				n += '<div class="dashboard-container-header-icon"><span class="icon-route-event"></span></div>',
				n += '<div class="dashboard-container-header-title">' + s + "</div>",
				n += '<div class="dashboard-container-header-menu"><a href="#" id="dashboard_events_action_menu_button"><span class="icon-action2"></span></a></div></div>',
				n += '<div id="dashboard_events_graph_plot"></div>',
				document.getElementById("dialog_dashboard_events").innerHTML = n,
				document.getElementById("dashboard_events_graph_plot").style.height = dashboardData.container_height - 30 - 20 + "px";
				...
				n += '<div class="dashboard-container-header-title">' + s + "</div>",
				n += '<div class="dashboard-container-header-menu"><a href="#" id="dashboard_events_action_menu_button"><span class="icon-action2"></span></a></div></div>',
				n += '<div id="dashboard_events_text" class="dashboard-container-text">' + la.NO_DATA_HAS_BEEN_COLLECTED_YET + "</div>",
				document.getElementById("dialog_dashboard_events").innerHTML = n,
				document.getElementById("dashboard_events_text").style.height = dashboardData.container_height - 30 - 20 + "px"
			}
			$("#dashboard_events_action_menu_button").click(function () {
				return $("#dashboard_objects_action_menu").hide(),
				$("#dashboard_tasks_action_menu").hide(),
	...
	$.ajax({
		...
		success: function (e) {
			if (Object.keys(e).length > 0) {
				...
				var d = '<div class="dashboard-container-header">';
				d += '<a href="#" onclick="dashboardOpenMaintenance();"><div class="dashboard-container-header-icon"><span class="icon-maintenance"></span></div><div class="dashboard-container-header-title">' + la.MAINTENANCE + "</div></a></div>",
				d += '<div id="dashboard_maintenance_graph_plot"></div>',
				document.getElementById("dialog_dashboard_maintenance").innerHTML = d,
				document.getElementById("dashboard_maintenance_graph_plot").style.height = dashboardData.container_height - 30 - 20 + "px";
				...
				d = '<div class="dashboard-container-header">';
				d += '<a href="#" onclick="dashboardOpenMaintenance();"><div class="dashboard-container-header-icon"><span class="icon-maintenance"></span></div><div class="dashboard-container-header-title">' + la.MAINTENANCE + "</div></a></div>",
				d += '<div id="dashboard_maintenance_text" class="dashboard-container-text">' + la.NO_DATA_HAS_BEEN_COLLECTED_YET + "</div>",
				document.getElementById("dialog_dashboard_maintenance").innerHTML = d,
				document.getElementById("dashboard_maintenance_text").style.height = dashboardData.container_height - 30 - 20 + "px"
			}
		}
	})
}
function dashboardInitTasksSetPeriod(e) {
	dashboardData.tasks_period = e,
	dashboardInitTasks()
}
function dashboardInitTasks() {
	if ("today" == dashboardData.tasks_period) var e = moment().format("YYYY-MM-DD") + " 00:00:00",
	t = moment().add("days", 1).format("YYYY-MM-DD") + " 00:00:00";
	else if ("this_week" == dashboardData.tasks_period) e = moment().isoWeekday(1).format("YYYY-MM-DD") + " 00:00:00",
	t = moment().add("days", 1).format("YYYY-MM-DD") + " 00:00:00";
	else if ("this_month" == dashboardData.tasks_period) e = moment().startOf("month").format("YYYY-MM-DD") + " 00:00:00",
	t = moment().add("days", 1).format("YYYY-MM-DD") + " 00:00:00";
	var a = {
		cmd: "load_tasks_data",
		dtf: e,
		...
		success: function (e) {
			if (Object.keys(e).length > 0) {
				...
				for (var a in e) {
					...
					o = e[a].count;
					color = "",
					0 == a ? color = "#AFD8F8": 1 == a ? color = "#EDC240": 2 == a ? color = "#4DA74D": 3 == a && (color = "#CB4B4B"),
					t.push({
						data: [[i, o]],
						color: color
					})
				...
				var n = '<div class="dashboard-container-header">';
				n += '<a href="#" onclick="dashboardOpenTasks();"><div class="dashboard-container-header-icon"><span class="icon-tasks"></span></div>',
				n += '<div class="dashboard-container-header-title">' + s + "</div></a>",
				n += '<div class="dashboard-container-header-menu"><a href="#" id="dashboard_tasks_action_menu_button"><span class="icon-action2"></span></a></div></div>',
				n += '<div id="dashboard_tasks_graph_plot" class="dashboard-container-graph-plot"></div>',
				document.getElementById("dialog_dashboard_tasks").innerHTML = n,
				document.getElementById("dashboard_tasks_graph_plot").style.height = dashboardData.container_height - 30 - 20 + "px";
				...
				n += '<div class="dashboard-container-header-title">' + s + "</div></a>",
				n += '<div class="dashboard-container-header-menu"><a href="#" id="dashboard_tasks_action_menu_button"><span class="icon-action2"></span></a></div></div>',
				n += '<div id="dashboard_tasks_text" class="dashboard-container-text">' + la.NO_DATA_HAS_BEEN_COLLECTED_YET + "</div>",
				document.getElementById("dialog_dashboard_tasks").innerHTML = n,
				document.getElementById("dashboard_tasks_text").style.height = dashboardData.container_height - 30 - 20 + "px"
			}
	...
	$.ajax({
		...
		success: function (e) {
			if (Object.keys(e).length > 0) {
				...
				i += '<div class="dashboard-container-header-icon"><span class="icon-odometer"></span></div><div class="dashboard-container-header-title">' + la.ODOMETER_TOP_10 + " (" + la.UNIT_DISTANCE + ")</div></div>",
				i += '<div id="dashboard_odometer_graph_plot" class="dashboard-container-graph-plot"></div>',
				document.getElementById("dialog_dashboard_odometer").innerHTML = i,
				document.getElementById("dashboard_odometer_graph_plot").style.height = dashboardData.container_height - 30 - 20 + "px";
				...
				i += '<div class="dashboard-container-header-icon"><span class="icon-odometer"></span></div><div class="dashboard-container-header-title">' + la.ODOMETER + " (" + la.UNIT_DISTANCE + ")</div></div>",
				i += '<div id="dashboard_odometer_text" class="dashboard-container-text">' + la.NO_DATA_HAS_BEEN_COLLECTED_YET + "</div>",
				document.getElementById("dialog_dashboard_odometer").innerHTML = i,
				document.getElementById("dashboard_odometer_text").style.height = dashboardData.container_height - 30 - 20 + "px"
			}
		}
	})
}
	...
	$.ajax({
		...
		success: function (e) {
			if (Object.keys(e).length > 0) {
				...
				a += '<div class="dashboard-container-header-icon"><span class="icon-odometer"></span></div><div class="dashboard-container-header-title">' + la.MILEAGE + " (" + la.UNIT_DISTANCE + ")</div></div>",
				a += '<div id="dashboard_mileage_graph_plot" class="dashboard-container-graph-plot"></div>',
				document.getElementById("dialog_dashboard_mileage").innerHTML = a,
				document.getElementById("dashboard_mileage_graph_plot").style.height = dashboardData.container_height - 30 - 20 + "px";
				...
				a += '<div class="dashboard-container-header-icon"><span class="icon-odometer"></span></div><div class="dashboard-container-header-title">' + la.MILEAGE + " (" + la.UNIT_DISTANCE + ")</div></div>",
				a += '<div id="dashboard_mileage_text" class="dashboard-container-text">' + la.NO_DATA_HAS_BEEN_COLLECTED_YET + "</div>",
				document.getElementById("dialog_dashboard_mileage").innerHTML = a,
				document.getElementById("dashboard_mileage_text").style.height = dashboardData.container_height - 30 - 20 + "px"
			}
		}
	})
}
...
function maintenanceObjectServiceProperties(e, t) {
	settingsEditData.object_imei = e,
	settingsObjectServiceProperties(t)
}
function maintenanceServiceProperties(e) {
	switch (e) {
	case "add":
		$("#dialog_maintenance_service_object_list option:selected").removeAttr("selected"),
		...
		document.getElementById("dialog_maintenance_service_data_list").checked = !1,
		document.getElementById("dialog_maintenance_service_popup").checked = !1,
		document.getElementById("dialog_maintenance_service_odo").checked = !1,
		document.getElementById("dialog_maintenance_service_odo_interval").value = "",
		document.getElementById("dialog_maintenance_service_odo_last").value = "",
		document.getElementById("dialog_maintenance_service_engh").checked = !1,
		document.getElementById("dialog_maintenance_service_engh_interval").value = "",
		document.getElementById("dialog_maintenance_service_engh_last").value = "",
		document.getElementById("dialog_maintenance_service_days").checked = !1,
		document.getElementById("dialog_maintenance_service_days_interval").value = "",
		document.getElementById("dialog_maintenance_service_days_last").value = "",
		document.getElementById("dialog_maintenance_service_odo_left").checked = !1,
		document.getElementById("dialog_maintenance_service_odo_left_num").value = "",
		document.getElementById("dialog_maintenance_service_engh_left").checked = !1,
		document.getElementById("dialog_maintenance_service_engh_left_num").value = "",
		document.getElementById("dialog_maintenance_service_days_left").checked = !1,
		document.getElementById("dialog_maintenance_service_days_left_num").value = "",
		document.getElementById("dialog_maintenance_service_update_last").checked = !1,
...
function expensesProperties(e) {
	...
	default:
		...
		$.ajax({
			...
			success: function (e) {
				...
				document.getElementById("dialog_expense_object_list").value = e.imei,
				$("#dialog_expense_object_list").multipleSelect("refresh"),
				document.getElementById("dialog_expense_date").value = e.dt_expense,
				document.getElementById("dialog_expense_quantity").value = e.quantity,
				document.getElementById("dialog_expense_cost").value = e.cost,
				document.getElementById("dialog_expense_supplier").value = e.supplier,
				document.getElementById("dialog_expense_buyer").value = e.buyer,
				document.getElementById("dialog_expense_odo").value = e.odometer,
				document.getElementById("dialog_expense_engh").value = e.engine_hours,
	...
	case "add":
		...
		$("#dialog_expense_object_list").multipleSelect("refresh"),
		document.getElementById("dialog_expense_date").value = moment().format("YYYY-MM-DD"),
...
function datalistBottomSwitch(e) {
	...
	case "object":
		document.getElementById("bottom_panel_datalist_object_data_list").style.display = "",
		document.getElementById("bottom_panel_datalist_event_data_list").style.display = "none",
		document.getElementById("bottom_panel_datalist_route_data_list").style.display = "none";
		break;
	case "event":
		document.getElementById("bottom_panel_datalist_object_data_list").style.display = "none",
		document.getElementById("bottom_panel_datalist_event_data_list").style.display = "",
		document.getElementById("bottom_panel_datalist_route_data_list").style.display = "none";
		break;
	case "route":
		document.getElementById("bottom_panel_datalist_object_data_list").style.display = "none",
		document.getElementById("bottom_panel_datalist_event_data_list").style.display = "none",
		document.getElementById("bottom_panel_datalist_route_data_list").style.display = ""
	}
}
function datalistBottomShowData(e, t, a) {
	if (1 == settingsUserData.privileges_rilogbook){
		// alert(settingsUserData.privileges_rilogbook);
		historyLoadRouteDblClick(t); // Grivera
	}
	...
	if (document.getElementById(n).innerHTML = "", "" != a) {
		...
		if ( - 1 !== l.indexOf("nearest_marker")) {
			var k = getNearestMarker(t, a.lat, a.lng);
			"" != k.name && D.push({
		...
		var T = "";
		for (i = 0; i < D.length; i += 1) {
			T += datalistBottomAddItem(o = "odd" == o ? "even": "odd", (C = D[i]).icon, C.name, C.value)
		}
		s += T;
		var R = new Array,
		...
		for (i = 0; i < R.length; i += 1) {
			x += datalistBottomAddItem(o = "odd" == o ? "even": "odd", (C = R[i]).icon, C.name, C.value)
		}
		s += x;
		var N = new Array;
		switch (e) {
...
function datalistBottomAddItem(e, t, a, i) {
	...
	return o += 0 == t ? '<span class="datalist-item-icon"></span>': '<span class="datalist-item-icon ' + t + '"></span>',
...
function datalistShowData(e, t, a) {
	if ("bottom_panel" != settingsUserData.datalist) {
		...
		switch (e) {
		case "object":
			s = "side_panel_objects_object_datalist_grid",
			o = $("#side_panel_objects_object_datalist_grid");
			break;
		case "event":
		...
		if (o.clearGridData(!0), "" != a) {
			...
			if ( - 1 !== n.indexOf("sim_number")) {
				var k = settingsObjectData[t].sim_number;
				"" != k && i.push({
					group_name: la.GENERAL,
			...
			for (var b in M) {
				var C = M[b];
				if ("true" == C.data_list) if ("fuelsumup" == C.type) {
...
function billingLoadData() {
	...
	timer_billingLoadData = setTimeout("billingLoadData();", 1e3 * gsValues.billing_refresh),
	billingUpdateCount(),
	...
	if (utilsCheckPrivileges("subuser")) {
		...
		$.ajax({
			...
			success: function (e) {
				...
				document.getElementById("dialog_billing_plan_use_period").innerHTML = a,
				document.getElementById("dialog_billing_plan_use_selected").innerHTML = 0,
				$("#dialog_billing_plan_use").dialog("option", "title", la.BILLING_PLAN + " - " + billingData.plan.name),
...
function billingPlanUseObjectLoadList() {
	...
	for (var t in e.clearGridData(!0), settingsObjectData) {
		...
		s = "true" == s ? '<img src="theme/images/tick-green.svg" />': '<img src="theme/images/remove-red.svg" style="width:12px;" />',
...
var chatMsgsScrollHandler = function () {
	0 == $(this).scrollTop() && 0 != chatData.first_msg_id && chatLoadMsgs("old"),
	$("#chat_msgs div").each(function () {
		if ($(this).position().top > 0) {
			var e = $(this).attr("title");
			if (null != e && e.length > 10) return "none" == document.getElementById("chat_msgs_dt").style.display && (document.getElementById("chat_msgs_dt").style.display = "block"),
			clearTimeout(timer_chatMsgsDTHide),
			timer_chatMsgsDTHide = setTimeout(function () {
				$("#chat_msgs_dt").fadeOut("slow")
			},
			3e3),
			document.getElementById("chat_msgs_dt").innerHTML = e.substring(0, 10),
			!1
		}
	})
},
...
function chatLoadData() {
	...
	$.ajax({
		...
		success: function (e) {
			...
			chatUpdateMsgCount(),
			chatUpdateMsgDt(),
			0 != e.last_msg_status && chatUpdateMsgDeliveryStatus(e.last_msg_status);
			var t = chatData.imei;
...
function chatLoadObjectList() {
	...
	for (var t in e.clearGridData(!0), settingsObjectData) {
		...
		if ("true" == a.active && chatIsObjectCompatible(t)) {
			...
			o += '<div class="right" id="chat_object_msg_count_' + t + '"></div></div>',
...
function chatUpdateMsgCount() {
	...
	if (null != document.getElementById("chat_msg_count")) {
		...
		if (e > 0 && "0" == document.getElementById("chat_msg_count").innerHTML) if ("" != settingsUserData.chat_notify) new Audio("snd/" + settingsUserData.chat_notify).play();
...
function chatUpdateMsgDt() {
	for (var e in chatData.msg_dt) if (null != document.getElementById("chat_object_msg_count_" + e)) {
		...
		success: function (t) {
			if ("" != t) {
				...
				for (var i in t) {
					...
					(chatData.first_msg_id > i || 0 == chatData.first_msg_id) && (chatData.first_msg_id = i),
					(chatData.last_msg_id < i || 0 == chatData.last_msg_id) && (chatData.last_msg_id = i)
				}
				if ("old" != e) {
					document.getElementById("chat_msgs_text").innerHTML = document.getElementById("chat_msgs_text").innerHTML + a,
					scrollToBottom("chat_msgs");
					var d = chatData.imei;
					s = t[i = chatData.last_msg_id].s,
					l = t[i].st;
...
function chatFormatMsg(e, t, a, i) {
	...
	else o = "chat-msg-client",
	s = "chat-msg-dt-client";
	return t.substring(0, 10) == moment().format("YYYY-MM-DD") && (t = t.substring(11, 19)),
	'<div class="chat-msg-container"><div title="' + t + '" class="' + o + '">' + i + '<div class="' + s + '">' + t + "</div></div></div>"
}
function chatUpdateMsgDeliveryStatus(e) {
	var t = !1;
	0 == e ? document.getElementById("chat_msg_status").innerHTML = "": 1 == e ? ("" == document.getElementById("chat_msg_status").innerHTML && (t = !0), document.getElementById("chat_msg_status").innerHTML = la.DELIVERED) : 2 == e && ("" == document.getElementById("chat_msg_status").innerHTML && (t = !0), document.getElementById("chat_msg_status").innerHTML = la.SEEN),
...
function imgLoadData() {
	...
	timer_imgLoadData = setTimeout("imgLoadData();", 1e3 * gsValues.img_refresh),
	1 == $("#dialog_image_gallery").dialog("isOpen") ? $("#image_gallery_list_grid").trigger("reloadGrid") : clearTimeout(timer_imgLoadData)
}
function imgFilter() {
...
function cmdStatusLoadData() {
	...
	timer_cmdLoadData = setTimeout("cmdStatusLoadData();", 1e3 * gsValues.cmd_status_refresh),
	1 == $("#dialog_cmd").dialog("isOpen") ? ($("#cmd_gprs_status_list_grid").trigger("reloadGrid"), $("#cmd_sms_status_list_grid").trigger("reloadGrid")) : clearTimeout(timer_cmdLoadData)
}
function cmdGPRSTemplateList() {
	...
	if (multiselectIsSelected(i)) {
		...
		for (a = 0; a < s.length; a += 1) if (null != settingsObjectData[s[0]] && null != settingsObjectData[s[a]] && (o = settingsObjectData[s[0]].protocol) != settingsObjectData[s[a]].protocol) {
			o = "";
			break
		}
		if ("" != o) {
			for (var n in gsValues.protocol_list) if (gsValues.protocol_list[n].name == o && null != gsValues.protocol_list[n].cmd && "" != gsValues.protocol_list[n].cmd) {
		...
		} else { (r = $('<optgroup label="' + la.CUSTOM + '" />')).appendTo(e),
...
function cmdGPRSTemplateSwitch() {
	...
	for (var i in gsValues.cmd_default) {
		...
		if (e == o.name) {
			t = o.name,
			null != o.params && (a = o.params);
			break
		}
	}
	"" != t ? (document.getElementById("cmd_gprs_cmd_type").disabled = !0, document.getElementById("cmd_gprs_cmd_type").value = "ascii", "" != a && (t = t + "," + a), document.getElementById("cmd_gprs_cmd").value = t) : "" != e ? (document.getElementById("cmd_gprs_cmd_type").disabled = !1, document.getElementById("cmd_gprs_cmd_type").value = cmdData.cmd_templates[e].type, document.getElementById("cmd_gprs_cmd").value = cmdData.cmd_templates[e].cmd) : (document.getElementById("cmd_gprs_cmd_type").disabled = !1, document.getElementById("cmd_gprs_cmd_type").value = "ascii", document.getElementById("cmd_gprs_cmd").value = ""),
...
function cmdGPRSExec(e, t, a, i) {
	if (utilsCheckPrivileges("viewer")) {
		...
		$.ajax({
			...
			success: function (e) {
				loadingData(!1),
				"OK" == e ? (cmdGPRSReset(), $("#cmd_gprs_status_list_grid").trigger("reloadGrid"), notifyBox("info", la.INFORMATION, la.COMMAND_SENT_FOR_EXECUTION, !0)) : "ERROR_NOT_SENT" == e && ($("#cmd_gprs_status_list_grid").trigger("reloadGrid"), notifyBox("error", la.ERROR, la.UNABLE_TO_SEND_SMS_MESSAGE, !0))
			},
			error: function (e, t) {
				loadingData(!1)
			}
...
function cmdSMSTemplateList() {
	...
	if (multiselectIsSelected(i)) {
		...
		} else { (l = $('<optgroup label="' + la.CUSTOM + '" />')).appendTo(e),
			e.options.add(new Option(la.CUSTOM, ""))
		}
		cmdSMSReset()
	}
...
function cmdSMSSend() {
	...
	if (multiselectIsSelected(e)) if (e = multiselectGetValues(e), "" != a) {
		var o = e.split(",");
...
function cmdSMSExec(e, t, a) {
	if (utilsCheckPrivileges("viewer")) {
		...
		$.ajax({
			...
			success: function (e) {
				loadingData(!1),
				"OK" == e ? (cmdSMSReset(), $("#cmd_sms_status_list_grid").trigger("reloadGrid"), notifyBox("info", la.INFORMATION, la.COMMAND_SENT_FOR_EXECUTION, !0)) : "ERROR_NOT_SENT" == e && ($("#cmd_sms_status_list_grid").trigger("reloadGrid"), notifyBox("error", la.ERROR, la.UNABLE_TO_SEND_SMS_MESSAGE, !0))
			},
			error: function (e, t) {
				loadingData(!1)
			}
...
function cmdSMSReset() {
	...
	$("#cmd_sms_template_list").multipleSelect("refresh"),
	document.getElementById("cmd_sms_cmd").value = ""
}
...
function cmdScheduleProperties(e) {
	...
	default:
		...
		$.ajax({
			...
			cache: !1,
			success: function (e) {
				document.getElementById("dialog_cmd_schedule_active").checked = strToBoolean(e.active),
				document.getElementById("dialog_cmd_schedule_name").value = e.name;
				var t = strToBoolean(e.exact_time);
				document.getElementById("dialog_cmd_schedule_exact_time").checked = t,
				cmdScheduleExactTimeSwitch(),
				1 == t ? (document.getElementById("dialog_cmd_schedule_exact_time_date").value = e.exact_time_dt.substring(0, 10), document.getElementById("dialog_cmd_schedule_exact_time_time").value = e.exact_time_dt.substring(11, 16)) : (document.getElementById("dialog_cmd_schedule_exact_time_date").value = "", document.getElementById("dialog_cmd_schedule_exact_time_time").value = "00:00"),
				...
				document.getElementById("dialog_cmd_schedule_protocol").value = e.protocol,
				$("#dialog_cmd_schedule_protocol").multipleSelect("refresh"),
				...
				document.getElementById("dialog_cmd_schedule_template_list").value = "",
				$("#dialog_cmd_schedule_template_list").multipleSelect("refresh"),
				document.getElementById("dialog_cmd_schedule_cmd_gateway").value = e.gateway,
				$("#dialog_cmd_schedule_cmd_gateway").multipleSelect("refresh"),
				document.getElementById("dialog_cmd_schedule_cmd_type").value = e.type,
				$("#dialog_cmd_schedule_cmd_type").multipleSelect("refresh"),
				document.getElementById("dialog_cmd_schedule_cmd_cmd").value = e.cmd
			}
		}),
...
function cmdTemplateProtocolList() {
	...
	if (a.options.length = 0, 1 == t) for (var i = getAllProtocolsArray(), o = 0; o < i.length; o++)"" != i[o] && a.options.add(new Option(i[o], i[o]));
	else for (var s in gsValues.protocol_list) {
...
function cmdTemplateProperties(e) {
	...
	default:
		...
		break;
	case "add":
		if (settingsUserData.cpanel_privileges=="super_admin"){
			...
			break;
				...
				alert("su cuenta no tiene privilegios para esta operacion");
				break
		}
	case "cancel":
...
function eventsLoadData() {
	...
	timer_eventsLoadData = setTimeout("eventsLoadData();", 1e3 * gsValues.event_refresh),
	eventsCheckForNew()
}
				...
				for (var t = 0; t < e.length; t++) {
					if (eventsData.last_id < e[t].event_id && 1 == eventsData.events_loaded && null != settingsObjectData[e[t].imei] && "true" == settingsObjectData[e[t].imei].active) {
						...
						if ("true" == o[0]) {
							...
							l = urlPosition(s, n),
							d = '<div class="row">';
							d += '<div class="row2"><div class="width40"><strong>' + la.OBJECT + ':</strong></div><div class="width60">' + e[t].name + "</div></div>",
							d += '<div class="row2"><div class="width40"><strong>' + la.EVENT + ':</strong></div><div class="width60">' + e[t].event_desc + "</div></div>",
							d += '<div class="row2"><div class="width40"><strong>' + la.POSITION + ':</strong></div><div class="width60">' + l + "</div></div>",
							d += '<div class="row2"><div class="width40"><strong>' + la.TIME + ':</strong></div><div class="width60">' + e[t].dt_tracker + "</div></div>",
							d += "</div>",
							d += '<div class="row">',
							d += '<center><a href="#" onclick="eventsShowEvent(' + e[t].event_id + ');">Show event</a></center>',
							d += "</div>";
							var r = !1;
							if ("true" == o[1] && (r = !0), notifyBox("error", la.NEW_EVENT, d, r), "true" == o[2]) null == o[3] && (o[3] = "alarm1.mp3"),
	...
	$.ajax({
		...
		success: function (e) {
			...
			geocoderGetAddress(t, a, function (o) {
				...
				for (var c in g) {
					var m = g[c];
					if ("true" == m.popup) if ("fuelsumup" == m.type) {
				...
				var v = p + r;
				addPopupToMap(t, a, [0, 0], p += "</table>", v += "</table>"),
				map.panTo({
					lat: t,
					lng: a
				}),
...
function initMap() {
	...
	gsValues.map_objects || document.getElementById("map_control_objects").click(),
	gsValues.map_object_labels || (iconObjectLabels.className = "icon-text disabled"),
	gsValues.map_markers || document.getElementById("map_control_markers").click(),
	gsValues.map_routes || document.getElementById("map_control_routes").click(),
...
function initGui() {
	$("#map_action_menu").menu({
		...
		select: function (e, t) {
			...
			"street_view_new" == i && utilsStreetViewPoint(a.lat, a.lng, !0),
			"show_point" == i && utilsPointOnMap(a.lat, a.lng),
			"route_to_point" == i && utilsRouteToPoint(a),
			"route_between_points" == i && utilsRouteBetweenPoints(a),
			"add_task" == i && tasksNew(a),
			"add_marker" == i && (document.getElementById("side_panel_places_tab").click(), document.getElementById("side_panel_places_markers_tab").click(), placesMarkerNew(a)),
			"add_route" == i && (document.getElementById("side_panel_places_tab").click(), document.getElementById("side_panel_places_routes_tab").click(), placesRouteNew(a)),
			"add_zone" == i && (document.getElementById("side_panel_places_tab").click(), document.getElementById("side_panel_places_zones_tab").click(), placesZoneNew(a))
		}
	}),
	$("#map_action_menu").hide(),
	$("#dashboard_objects_action_menu").menu({
		role: "listbox"
	}),
	$("#dashboard_objects_action_menu").hide(),
	$("#dashboard_events_action_menu").menu({
		role: "listbox"
	}),
	$("#dashboard_events_action_menu").hide(),
	...
	$("#side_panel_history_import_export_action_menu_button").click(function () {
	...
	$("#report_action_menu").menu({
		...
		select: function (e, t) {
			...
			if ("grlh" == i) {
				...
				o += " " + moment().subtract("hour", 1).format("HH") + ":" + moment().subtract("hour", 1).format("mm") + ":00",
				s += " " + moment().format("HH") + ":" + moment().format("mm") + ":00"
			}
			if ("grt" == i) o = moment().format("YYYY-MM-DD") + " 00:00:00",
			s = moment().add("days", 1).format("YYYY-MM-DD") + " 00:00:00";
			if ("gry" == i) o = moment().subtract("days", 1).format("YYYY-MM-DD") + " 00:00:00",
			s = moment().format("YYYY-MM-DD") + " 00:00:00";
			if ("grb2" == i) o = moment().subtract("days", 2).format("YYYY-MM-DD") + " 00:00:00",
			s = moment().subtract("days", 1).format("YYYY-MM-DD") + " 00:00:00";
			if ("grb3" == i) o = moment().subtract("days", 3).format("YYYY-MM-DD") + " 00:00:00",
			s = moment().subtract("days", 2).format("YYYY-MM-DD") + " 00:00:00";
			if ("grtw" == i) o = moment().isoWeekday(1).format("YYYY-MM-DD") + " 00:00:00",
			s = moment().add("days", 1).format("YYYY-MM-DD") + " 00:00:00";
			if ("grlw" == i) o = moment().isoWeekday(1).subtract("week", 1).format("YYYY-MM-DD") + " 00:00:00",
			s = moment().isoWeekday(1).format("YYYY-MM-DD") + " 00:00:00";
			if ("grtm" == i) o = moment().startOf("month").format("YYYY-MM-DD") + " 00:00:00",
			s = moment().add("days", 1).format("YYYY-MM-DD") + " 00:00:00";
			if ("grlm" == i) o = moment().startOf("month").subtract("month", 1).format("YYYY-MM-DD") + " 00:00:00",
	...
	$("#side_panel,\t  #side_panel_places,\t  #bottom_panel_tabs,\t  #settings_main,\t  #settings_main_objects_groups_drivers,\t  #settings_object,\t  #settings_object_edit_select_icon_tabs,\t  #settings_event,\t  #reports_tabs,\t  #cmd_tabs,\t  #places_marker_icon_tabs").tabs({}),
	...
	$("#side_panel_objects_dragbar").mousedown(function (e) {
		e.preventDefault(),
		$(document).mousemove(guiDragbarObjectsHandler)
	}),
	$("#side_panel_events_dragbar").mousedown(function (e) {
		e.preventDefault(),
		$(document).mousemove(guiDragbarEventsHandler)
	}),
	$("#side_panel_history_dragbar").mousedown(function (e) {
		e.preventDefault(),
		$(document).mousemove(guiDragbarHistoryHandler)
	}),
	$("#bottom_panel_dragbar").mousedown(function (e) {
		e.preventDefault(),
		$(document).mousemove(guiDragbarBottomPanelHandler)
	}),
	$(document).mouseup(function (e) {
		...
		$(document).unbind("mousemove", guiDragbarBottomPanelHandler)
	}),
	map.on("contextmenu", function (e) {
		menuOnItem = e.latlng,
		$("#map_action_menu").toggle().position({
			my: "left top",
	...
	$("#side_panel_history_filter").multipleSelect("refresh"),
	...
	switchDateFilter("tasks"),
	switchDateFilter("rilogbook"),
	switchDateFilter("dtc"),
	switchDateFilter("img")
}
...
var guiDragbarObjectsHandler = function (e) {
	...
	resizeGridObjects(e.pageY)
},
guiDragbarEventsHandler = function (e) {
	$("#map").css("pointer-events", "none"),
	resizeGridEvents(e.pageY)
},
guiDragbarHistoryHandler = function (e) {
	$("#map").css("pointer-events", "none"),
	resizeGridHistory(e.pageY)
},
...
function addPopupToMap(e, t, a, i, o) {
	if ("" != o && i != o) {
		...
		i += '<div style="width:100%; text-align: right;"><a href="#" class="" onClick="switchPopupDetailed(true);">' + la.DETAILED + "</a></div>",
		i += "</div>",
		i += '<div id="popup_detailed" ' + n + ">" + o,
		i += '<div style="width:100%; text-align: right;"><a href="#" class="" onClick="switchPopupDetailed(false);">' + la.SHORT + "</a></div>",
		i += "</div>"
	}
	mapPopup = L.popup({
		offset: a
...
function switchPopupDetailed(e) {
	switch (e) {
	case ! 1 : document.getElementById("popup_short").style.display = "",
		document.getElementById("popup_detailed").style.display = "none",
		gsValues.map_popup_detailed = !1;
		break;
	case ! 0 : document.getElementById("popup_short").style.display = "none",
...
function rotateMarker(e, t, a) {
	$("#" + e.markers[t].icon.imageDiv.id).css("-moz-transform", "rotate(" + a + "deg)"),
	$("#" + e.markers[t].icon.imageDiv.id).css("-webkit-transform", "rotate(" + a + "deg)"),
	$("#" + e.markers[t].icon.imageDiv.id).css("-o-transform", "rotate(" + a + "deg)")
}
function createCluster(e) {
	...
	o = "marker-cluster";
		...
		a = "img/markers/clusters/markers.svg",
		o = "marker-cluster"
	}
	...
	var n = new L.MarkerClusterGroup({
		...
		iconCreateFunction: function (e) {
			...
			s = " cluster-";
			return s += i < 10 ? "small": i < 100 ? "medium": "large",
			L.divIcon({
	...
	return "objects" == e && "true" == settingsUserData.map_ocp && n.on("clustermouseover", function (e) {
		...
		for (i = 0; i < a.length; i++) {
			...
			o += '<tr><td style="white-space: nowrap;"><strong>' + l + '</strong></td><td></td><td style="white-space: nowrap;">' + d + " " + la.UNIT_SPEED + "</td><td>" + _ + "</td><td>" + c + "</td></tr>",
			i > 9 && (s = !0)
		}
		o = "<table>" + o + "</table>",
	...
	return L.Control.extend({
		...
		onAdd: function (e) {
			...
			L.DomEvent.on(linkKML, "click", function (t) {
				1 == e.hasLayer(mapLayers.kml) ? (e.removeLayer(mapLayers.kml), iconRoutes.className = "icon-kml disabled", gsValues.map_kml = !1) : (e.addLayer(mapLayers.kml), iconRoutes.className = "icon-kml", gsValues.map_kml = !0)
			}),
			...
			1 == gsValues.map_clusters ? iconClusters.className = "icon-clusters": iconClusters.className = "icon-clusters disabled";
			a = L.DomEvent.stopPropagation;
			if (L.DomEvent.on(linkClusters, "dblclick", a), L.DomEvent.on(linkClusters, "mousedown", a), L.DomEvent.on(linkClusters, "click", function (e) {
				...
				L.DomEvent.on(linkCamera, "click", function (e) {
					if (1 == gsValues.map_camera) document.getElementById("camera_control").style.display = "",
					iconCamera.className = "icon-gallery disabled",
					gsValues.map_camera = !1;
					else for (var t in document.getElementById("camera_control").style.display = "block", iconCamera.className = "icon-gallery", gsValues.map_camera = !0, objectsData) 1 == objectsData[t].selected && utilsCamera(t);
			...
			if (gsValues.map_google && gsValues.map_google_street_view) {
				...
				L.DomEvent.on(linkStreetView, "click", function (e) {
					if (1 == gsValues.map_street_view) document.getElementById("street_view_control").style.display = "",
					iconStreetView.className = "icon-street disabled",
					gsValues.map_street_view = !1;
					else for (var t in document.getElementById("street_view_control").style.display = "block", iconStreetView.className = "icon-street", gsValues.map_street_view = !0, objectsData) {
	...
	return L.Control.extend({
		...
		onAdd: function (e) {
			...
			L.DomEvent.on(linkRuler, "click", function (e) {
				utilsRuler(),
				1 == utilsRulerData.enabled ? iconRuler.className = "icon-ruler": iconRuler.className = "icon-ruler disabled"
			}),
			...
			a = L.DomEvent.stopPropagation;
			return L.DomEvent.on(linkMeasure, "dblclick", a),
			L.DomEvent.on(linkMeasure, "mousedown", a),
			L.DomEvent.on(linkMeasure, "click", function (e) {
				utilsArea(),
				1 == utilsAreaData.enabled ? iconMeasure.className = "icon-measure": iconMeasure.className = "icon-measure disabled"
			}),
			t
		}
	})
...
function initGraph(e) {
	...
	var s = {
		...
		yaxis: {
			tickFormatter: function (t) {
				var i = "";
				return e && (i = Math.round(100 * t) / 100 + " " + a),
				i
			},
			zoomRange: [0, 0],
			panRange: !1
	...
	$("#bottom_panel_graph_plot").bind("plothover", function (e, i, o) {
		if (o) {
			var s = o.datapoint[0],
	...
	$("#bottom_panel_graph_plot").bind("plotselected", function (e, a) {
		historyGraphPlot = $.plot($("#bottom_panel_graph_plot"), [t], $.extend(!0, {},
		s, {
			xaxis: {
				min: a.xaxis.from,
				max: a.xaxis.to
	...
	$("#bottom_panel_graph_plot").bind("plotclick", function (e, i, o) {
		if (o) {
			var s = o.datapoint[0],
			n = historyRouteData.graph.data_index[s],
			l = historyRouteData.route[n].dt_tracker;
			...
			historyRouteAddPointMarkerToMap(n),
			0 == historyRouteData.play.status && historyRouteShowPoint(n, !0)
		}
	})
}
...
function initSelectList(e) {
	switch (e) {
	case "map_layer_list":
		(o = document.getElementById("map_layer")).options.length = 0,
		gsValues.map_osm && o.options.add(new Option("OSM Map", "osm")),
		gsValues.map_bing && (o.options.add(new Option("Bing Road", "broad")), o.options.add(new Option("Bing Aerial", "baer")), o.options.add(new Option("Bing Hybrid", "bhyb"))),
		gsValues.map_google && (o.options.add(new Option("Google Streets", "gmap")), o.options.add(new Option("Google Satellite", "gsat")), o.options.add(new Option("Google Hybrid", "ghyb")), o.options.add(new Option("Google Terrain", "gter"))),
		gsValues.map_mapbox && (o.options.add(new Option("Mapbox Streets", "mbmap")), o.options.add(new Option("Mapbox Satellite", "mbsat"))),
		gsValues.map_yandex && o.options.add(new Option("Yandex", "yandex"));
	...
	case "tasks_object_list":
		...
		sortSelectList(o),
		o.options.add(new Option(la.ALL_OBJECTS, ""), 0),
		o.value = "";
		break;
	...
	case "object_group_list":
		...
		for (var n in o.options.length = 0, settingsObjectGroupData) { (h = settingsObjectGroupData[n]).name != la.UNGROUPED && o.options.add(new Option(h.name, n))
		}
		sortSelectList(o),
		o.options.add(new Option(la.UNGROUPED, 0), 0);
		break;
	case "object_driver_list":
		...
		sortSelectList(o),
		o.options.add(new Option(la.AUTO_ASSIGN, 0), 0),
		o.options.add(new Option(la.NO_DRIVER, -1), 0);
		break;
	case "object_trailer_list":
		...
		sortSelectList(o),
		o.options.add(new Option(la.AUTO_ASSIGN, 0), 0),
		o.options.add(new Option(la.NO_TRAILER, -1), 0);
		break;
	case "email_sms_template_list":
		...
		for (var n in g.options.length = 0, settingsTemplateData) {
			...
			c.options.add(new Option(m.name, n)),
			g.options.add(new Option(m.name, n))
		}
		sortSelectList(c),
		sortSelectList(g),
		c.options.add(new Option(la.DEFAULT, 0), 0),
		g.options.add(new Option(la.DEFAULT, 0), 0);
		break;
	case "places_group_list":
		...
		sortSelectList(p),
		sortSelectList(y),
		u.options.add(new Option(la.UNGROUPED, 0), 0),
		p.options.add(new Option(la.UNGROUPED, 0), 0),
		y.options.add(new Option(la.UNGROUPED, 0), 0)
	}
}
...
function resizeGridObjects(e) {
	if ("bottom_panel" == settingsUserData.datalist) {
		...
		null == e ? e = window.innerHeight - guiDragbars.objects: guiDragbars.objects = window.innerHeight - e,
		e < 295 && (e = 292),
		e > window.innerHeight - 173 && (e = window.innerHeight - 173);
...
function resizeGridEvents(e) {
	if ("bottom_panel" == settingsUserData.datalist) {
		...
		null == e ? e = window.innerHeight - guiDragbars.events: guiDragbars.events = window.innerHeight - e,
		e < 292 && (e = 292),
		e > window.innerHeight - 173 && (e = window.innerHeight - 173);
		var a = window.innerHeight - e - 16;
...
function resizeGridHistory(e) {
	if ("bottom_panel" == settingsUserData.datalist) {
		...
		null == e ? e = window.innerHeight - guiDragbars.history: guiDragbars.history = window.innerHeight - e,
		e < 430 && (e = 430),
		e > window.innerHeight - 173 && (e = window.innerHeight - 173);
		var a = window.innerHeight - e - 16;
...
function showBottomPanel(e) {
	...
	guiDragbars.bottom_panel < 171 && (guiDragbars.bottom_panel = 171),
	guiDragbars.bottom_panel > window.innerHeight / 2 && (guiDragbars.bottom_panel = window.innerHeight / 2),
	$("#bottom_panel").css("height", guiDragbars.bottom_panel),
	document.getElementById("map").style.bottom = parseInt(guiDragbars.bottom_panel) + 5 + "px",
	document.getElementById("bottom_panel_dragbar").style.bottom = guiDragbars.bottom_panel + "px",
	$("#bottom_panel_msg_list_grid").setGridHeight(guiDragbars.bottom_panel - 99),
	$("#bottom_panel_graph_plot").css("height", guiDragbars.bottom_panel - 75),
	$("#bottom_panel_dragbar").css("cursor", "row-resize"),
	document.getElementById("camera_control").style.bottom = parseInt(guiDragbars.bottom_panel) + 16 + "px",
	document.getElementById("street_view_control").style.bottom = parseInt(guiDragbars.bottom_panel) + 16 + "px",
	datalistBottomResize(),
...
function hideBottomPanel(e) {
	...
	document.getElementById("map").style.bottom = "5px",
	document.getElementById("bottom_panel_dragbar").style.bottom = "0px",
	$("#bottom_panel_dragbar").css("cursor", ""),
	document.getElementById("camera_control").style.bottom = "16px",
	document.getElementById("street_view_control").style.bottom = "16px",
	1 == e && map.invalidateSize(!0)
}
function resizeBottomPanel(e) {
	guiDragbars.bottom_panel = window.innerHeight - e,
	guiDragbars.bottom_panel -= 3,
	guiDragbars.bottom_panel < 150 ? hideBottomPanel() : showBottomPanel(!1)
}
function initGrids() {
	...
	$("#settings_main_object_list_grid").setCaption('<div class="row4"><input id="settings_main_object_list_search" class="inputbox-search" type="text" value="" placeholder="' + la.SEARCH + '" maxlength="25"></div>'),
	$("#settings_main_object_list_search").bind("keyup", function (e) {
	...
	$("#settings_object_sensor_list_grid_action_menu_button").click(function () {
	...
	$("#settings_object_service_list_grid_action_menu_button").click(function () {
	...
	$("#settings_object_custom_fields_list_grid_action_menu_button").click(function () {
	...
	$("#settings_main_object_group_list_grid").setCaption('<div class="row4"><input id="settings_main_object_group_list_search" class="inputbox-search" type="text" value="" placeholder="' + la.SEARCH + '" maxlength="25"></div>'),
	$("#settings_main_object_group_list_search").bind("keyup", function (e) {
	...
	$("#settings_main_object_group_list_grid_action_menu_button").click(function () {
	...
	$("#settings_main_object_driver_list_grid").setCaption('<div class="row4"><input id="settings_main_object_driver_list_search" class="inputbox-search" type="text" value="" placeholder="' + la.SEARCH + '" maxlength="25"></div>'),
	$("#settings_main_object_driver_list_search").bind("keyup", function (e) {
	...
	$("#settings_main_object_driver_list_grid_action_menu_button").click(function () {
	...
	$("#settings_main_object_passenger_list_grid").setCaption('<div class="row4"><input id="settings_main_object_passenger_list_search" class="inputbox-search" type="text" value="" placeholder="' + la.SEARCH + '" maxlength="25"></div>'),
	$("#settings_main_object_passenger_list_search").bind("keyup", function (e) {
	...
	$("#settings_main_object_passenger_list_grid_action_menu_button").click(function () {
	...
	$("#settings_main_object_trailer_list_grid").setCaption('<div class="row4"><input id="settings_main_object_trailer_list_search" class="inputbox-search" type="text" value="" placeholder="' + la.SEARCH + '" maxlength="25"></div>'),
	$("#settings_main_object_trailer_list_search").bind("keyup", function (e) {
	...
	$("#settings_main_object_trailer_list_grid_action_menu_button").click(function () {
	...
	$("#settings_main_events_event_list_grid").setCaption('<div class="row4"><input id="settings_main_events_event_list_search" class="inputbox-search" type="text" value="" placeholder="' + la.SEARCH + '" maxlength="25"></div>'),
	$("#settings_main_events_event_list_search").bind("keyup", function (e) {
	...
	$("#settings_main_events_event_list_grid_action_menu_button").click(function () {
	...
	$("#settings_main_templates_template_list_grid").setCaption('<div class="row4"><input id="settings_main_templates_template_list_search" class="inputbox-search" type="text" value="" placeholder="' + la.SEARCH + '" maxlength="25"></div>'),
	$("#settings_main_templates_template_list_search").bind("keyup", function (e) {
	...
	$("#settings_main_templates_template_list_grid_action_menu_button").click(function () {
	...
	$("#settings_main_kml_kml_list_grid").setCaption('<div class="row4"><input id="settings_main_kml_list_search" class="inputbox-search" type="text" value="" placeholder="' + la.SEARCH + '" maxlength="25"></div>'),
	$("#settings_main_kml_list_search").bind("keyup", function (e) {
	...
	$("#settings_main_kml_kml_list_grid_action_menu_button").click(function () {
	...
	$("#settings_main_subaccount_list_grid").setCaption('<div class="row4"><input id="settings_main_subaccount_list_search" class="inputbox-search" type="text" value="" placeholder="' + la.SEARCH + '" maxlength="25"></div>'),
	$("#settings_main_subaccount_list_search").bind("keyup", function (e) {
	...
	$("#settings_main_subaccount_list_grid_action_menu_button").click(function () {
	...
	e += '<center><input id="object_group_follow_{0}" type="checkbox" onClick="objectGroupFollowToggle({0});"></center>',
	e += "</div>",
	e += '<div style="float: right;"><span id="object_group_name_{0}"></span> ({1})</div>',
	$("#side_panel_objects_object_list_grid").jqGrid({
		...
		onCellSelect: function (e, t, a, i) {
			objectSelect(e),
			5 == t ? objectPanToZoom(e) : objectPanTo(e)
		}
	}),
	$("#side_panel_objects_object_list_grid").setCaption('<div class="row4">\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class="width71">\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input id="side_panel_objects_object_list_search" class="inputbox-search" type="text" value="" placeholder="' + la.SEARCH + '" maxlength="25">\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class="float-right">\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a href="#" onclick="objectReloadData();">\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class="panel-button" title="' + la.RELOAD + '">\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<img src="theme/images/refresh-color.svg" width="16px" border="0"/>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</a>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a href="#" onclick="sharePositionOpen();">\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class="panel-button" title="' + la.SHARE_POSITION + '">\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<img src="theme/images/share-orange.svg" width="16px" border="0"/>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</a>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a href="#" onclick="settingsObjectAdd(\'open\');">\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class="panel-button" title="' + la.ADD_OBJECT + '">\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<img src="theme/images/object-add.svg" width="16px" border="0"/>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</a>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>'),
	...
	$("#side_panel_events_event_list_grid").setCaption('<div class="row4">\t\t\t\t\t\t\t\t\t<div class="width71">\t\t\t\t\t\t\t\t\t\t<input id="side_panel_events_event_list_search" class="inputbox-search" type="text" value="" placeholder="' + la.SEARCH + '" maxlength="25">\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t<div class="float-right">\t\t\t\t\t\t\t\t\t\t<a href="#" onclick="eventsReloadData();">\t\t\t\t\t\t\t\t\t\t<div class="panel-button" title="' + la.RELOAD + '">\t\t\t\t\t\t\t\t\t\t\t<img src="theme/images/refresh-color.svg" width="16px" border="0"/>\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t</a>\t\t\t\t\t\t\t\t\t\t<a href="#" onclick="eventsExport();">\t\t\t\t\t\t\t\t\t\t<div class="panel-button" title="' + la.EXPORT + '">\t\t\t\t\t\t\t\t\t\t\t<img src="theme/images/export.svg" width="16px" border="0"/>\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t</a>\t\t\t\t\t\t\t\t\t\t<a href="#" onclick="eventsDeleteAll();">\t\t\t\t\t\t\t\t\t\t<div class="panel-button" title="' + la.DELETE_ALL_EVENTS + '">\t\t\t\t\t\t\t\t\t\t\t<img src="theme/images/remove2.svg" width="16px" border="0"/>\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t</a>\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t</div>'),
	...
	$("#places_group_list_grid").setCaption('<div class="row4"><input id="places_group_list_search" class="inputbox-search" type="text" value="" placeholder="' + la.SEARCH + '" maxlength="25"></div>'),
	$("#places_group_list_search").bind("keyup", function (e) {
	...
	e += "</div>",
	e += '<div style="float: right;"><span id="marker_group_name_{0}"></span> ({1})</div>',
	...
	e += "</div>",
	e += '<div style="float: right;"><span id="route_group_name_{0}"></span> ({1})</div>',
	...
	e += "</div>",
	e += '<div style="float: right;"><span id="zone_group_name_{0}"></span> ({1})</div>',
		...
		loadComplete: function (e) {
			for (var t = $(this).getDataIDs(), a = historyRouteData.imei, i = 0; i < t.length; i++) {
				...
				if ("point" == s) {
					...
					0 != (c = historyRouteData.fuel_cost) && (l += "<tr><td>" + la.FUEL_COST + ":</td><td>" + c + " " + settingsUserData.currency + "</td></tr>"),
					0 != getSensorFromType(a, "acc") && (l += "<tr><td>" + la.ENGINE_WORK + ":</td><td>" + historyRouteData.engine_work + "</td></tr>", l += "<tr><td>" + la.ENGINE_IDLE + ":</td><td>" + historyRouteData.engine_idle + "</td></tr>"),
					l += "</table>"
				} else if ("drive" == s) {
					var d, r;
					l = "<table>";
					...
					0 != (c = historyRouteData.drives[n].fuel_cost) && (l += "<tr><td>" + la.FUEL_COST + ":</td><td>" + c + " " + settingsUserData.currency + "</td></tr>"),
					l += "</table>"
				} else if ("stop" == s) {
					var _, c;
					l = "<table>";
					l += "<tr><td>" + la.ARRIVED + ":</td><td>" + historyRouteData.stops[n].dt_start + "</td></tr>",
					l += "<tr><td>" + la.DEPARTED + ":</td><td>" + historyRouteData.stops[n].dt_end + "</td></tr>",
					0 != (_ = historyRouteData.stops[n].fuel_consumption) && (l += "<tr><td>" + la.FUEL_CONSUMPTION + ":</td><td>" + _ + " " + la.UNIT_CAPACITY + "</td></tr>"),
					0 != (c = historyRouteData.stops[n].fuel_cost) && (l += "<tr><td>" + la.FUEL_COST + ":</td><td>" + c + " " + settingsUserData.currency + "</td></tr>"),
					0 != getSensorFromType(a, "acc") && (l += "<tr><td>" + la.ENGINE_IDLE + ":</td><td>" + historyRouteData.stops[n].engine_idle + "</td></tr>"),
					l += "</table>"
				}
	...
	$("#bottom_panel_msg_list_grid").jqGrid({
		...
		beforeSelectRow: function (e, t) {
			...
			return 0 != a && 0 != i && utilsPointOnMap(a, i),
			!1
		},
		shrinkToFit: !0,
		multiselect: !0
	...
	$("#share_position_list_grid").jqGrid({
		url: "func/fn_share.php?cmd=load_share_position_list",
		datatype: "json",
		colNames: [la.NAME, la.EMAIL, la.PHONE, la.OBJECT, la.ACTIVE, la.EXPIRES_ON, "", ""],
		colModel: [{
			name: "name",
			index: "name",
			width: 80,
	...
	$("#share_position_list_grid_action_menu_button").click(function () {
	...
	$("#expenses_list_grid_action_menu_button").click(function () {
	...
	$("#cmd_gprs_status_list_grid").jqGrid({
		...
		subGridRowExpanded: function (e, t) {
			...
			i = hexToAscii(a),
			o = "";
			"" == i && "" == a ? o = la.NO_DATA: (o = '<table style="table-layout: fixed; width: 100%">', o += '<tr><td style="width: 40px;">ASCII:</td><td style="word-wrap: break-word;">' + i + "</td></tr>", o += '<tr><td>HEX:</td><td style="word-wrap:break-word;">' + a + "</td></tr>", o += "</table>"),
			$("#" + e).html(o)
		}
	}),
	...
	$("#image_gallery_list_grid").jqGrid({
		...
		beforeSelectRow: function (e, t) {
			...
			return document.getElementById("image_gallery_img_data").innerHTML = s,
...
function switchDateFilter(e) {
	...
	case "0":
		document.getElementById(t + "date_from").value = moment().format("YYYY-MM-DD"),
		document.getElementById(t + "date_to").value = moment().format("YYYY-MM-DD");
		break;
	case "1":
		document.getElementById(t + "date_from").value = moment().format("YYYY-MM-DD"),
		document.getElementById(t + "date_to").value = moment().format("YYYY-MM-DD"),
		document.getElementById(t + "hour_from").value = moment().subtract("hour", 1).format("HH"),
		document.getElementById(t + "hour_to").value = moment().format("HH"),
		document.getElementById(t + "minute_from").value = moment().subtract("hour", 1).format("mm"),
		document.getElementById(t + "minute_to").value = moment().format("mm");
		break;
	case "2":
		document.getElementById(t + "date_from").value = moment().format("YYYY-MM-DD"),
		document.getElementById(t + "date_to").value = moment().add("days", 1).format("YYYY-MM-DD");
		break;
	case "3":
		document.getElementById(t + "date_from").value = moment().subtract("days", 1).format("YYYY-MM-DD"),
		document.getElementById(t + "date_to").value = moment().format("YYYY-MM-DD");
		break;
	case "4":
		document.getElementById(t + "date_from").value = moment().subtract("days", 2).format("YYYY-MM-DD"),
		document.getElementById(t + "date_to").value = moment().subtract("days", 1).format("YYYY-MM-DD");
		break;
	case "5":
		document.getElementById(t + "date_from").value = moment().subtract("days", 3).format("YYYY-MM-DD"),
		document.getElementById(t + "date_to").value = moment().subtract("days", 2).format("YYYY-MM-DD");
		break;
	case "6":
		document.getElementById(t + "date_from").value = moment().isoWeekday(1).format("YYYY-MM-DD"),
		document.getElementById(t + "date_to").value = moment().add("days", 1).format("YYYY-MM-DD");
		break;
	case "7":
		document.getElementById(t + "date_from").value = moment().isoWeekday(1).subtract("week", 1).format("YYYY-MM-DD"),
		document.getElementById(t + "date_to").value = moment().isoWeekday(1).format("YYYY-MM-DD");
		break;
	case "8":
		document.getElementById(t + "date_from").value = moment().startOf("month").format("YYYY-MM-DD"),
		document.getElementById(t + "date_to").value = moment().add("days", 1).format("YYYY-MM-DD");
		break;
	case "9":
		document.getElementById(t + "date_from").value = moment().startOf("month").subtract("month", 1).format("YYYY-MM-DD"),
		document.getElementById(t + "date_to").value = moment().startOf("month").format("YYYY-MM-DD")
	}
		...
		if ("" != e) {
			...
			$.ajax({
				...
				success: function (e) {
					...
					if ("" == t.route || t.route.length < 2) return notifyBox("info", la.INFORMATION, la.NOTHING_HAS_BEEN_FOUND_ON_YOUR_REQUEST),
					void loadingData(!1);
				...
				error: function (e, t) {
					notifyBox("info", la.INFORMATION, la.NOTHING_HAS_BEEN_FOUND_ON_YOUR_REQUEST),
					loadingData(!1)
				}
			})
		} else notifyBox("info", la.INFORMATION, la.NOTHING_HAS_BEEN_FOUND_ON_YOUR_REQUEST)
...
// Seguimiento en pantalla Grivera
function historyLoadRouteDblClick(a) {
	if (idSeg != a){
		if (utilsCheckPrivileges("history")) {
			var e = document.getElementById("side_panel_history_object_list").value,
			t = document.getElementById("side_panel_history_object_list").options[document.getElementById("side_panel_history_object_list").selectedIndex].text,
...
function historyShowRoute(e, t, a) {
	if (historyHideRoute(), objectFollowAll(!1), "" == (historyRouteData = e).route || historyRouteData.route.length < 2) return notifyBox("info", la.INFORMATION, la.NOTHING_HAS_BEEN_FOUND_ON_YOUR_REQUEST),
	loadingData(!1),
...
function historyRouteRouteToggle() {
	historyRouteToggle.route ? (historyRouteToggle.route = !1, document.getElementById("history_view_control_route").className = "icon-route-route disabled") : (historyRouteToggle.route = !0, document.getElementById("history_view_control_route").className = "icon-route-route"),
	historyRouteRoute()
}
...
function historyRouteSnapToggle() {
	historyRouteToggle.snap ? (historyRouteToggle.snap = !1, document.getElementById("history_view_control_snap").className = "icon-route-snap disabled") : (historyRouteToggle.snap = !0, document.getElementById("history_view_control_snap").className = "icon-route-snap"),
	historyRouteSnap()
}
function historyRouteSnap() {
	if (null != historyRouteData.route) if (historyRouteToggle.snap) if (0 == historyRouteData.layers.route_snap && 0 == historyRouteData.layers.arrows_snap) {
		var e = new Array,
		t = Math.floor(historyRouteData.route.length / 99);
		for (t < 1 && (t = 1), i = 0; i < historyRouteData.route.length; i += t) lat = historyRouteData.route[i].lat,
		...
		a.on("routeselected", function (t) {
			...
			historyRouteData.layers.arrows_snap = L.polylineDecorator(historyRouteData.layers.route_snap, {
				patterns: [{
					offset: 25,
					repeat: 250,
					symbol: L.Symbol.arrowHead({
...
function historyRouteArrowsToggle() {
	historyRouteToggle.arrows ? (historyRouteToggle.arrows = !1, document.getElementById("history_view_control_arrows").className = "icon-route-arrow disabled") : (historyRouteToggle.arrows = !0, document.getElementById("history_view_control_arrows").className = "icon-route-arrow"),
	historyRouteArrows()
}
...
function historyRouteDataPointsToggle() {
	historyRouteToggle.data_points ? (historyRouteToggle.data_points = !1, document.getElementById("history_view_control_data_points").className = "icon-route-data-point disabled") : (historyRouteToggle.data_points = !0, document.getElementById("history_view_control_data_points").className = "icon-route-data-point"),
	historyRouteDataPoints()
}
function historyRouteDataPoints() {
	if (null != historyRouteData.layers) if (map.getZoom() >= 14) for (i = 0; i < historyRouteData.layers.data_points.length; i++) {
	...
	} else for (i = 0; i < historyRouteData.layers.data_points.length; i++) {
		e = historyRouteData.layers.data_points[i];
		mapLayers.history.removeLayer(e)
	}
}
function historyRouteStopsToggle() {
	historyRouteToggle.stops ? (historyRouteToggle.stops = !1, document.getElementById("history_view_control_stops").className = "icon-route-stop disabled") : (historyRouteToggle.stops = !0, document.getElementById("history_view_control_stops").className = "icon-route-stop"),
	historyRouteStops()
}
...
function historyRouteEventsToggle() {
	historyRouteToggle.events ? (historyRouteToggle.events = !1, document.getElementById("history_view_control_events").className = "icon-route-event disabled") : (historyRouteToggle.events = !0, document.getElementById("history_view_control_events").className = "icon-route-event"),
	historyRouteEvents()
}
...
function historyRouteCreateGraphSourceList() {
	...
	var a = new Array;
	for (var i in settingsObjectData[e].sensors) { (s = settingsObjectData[e].sensors[i]).id = i,
		a.push(s)
	}
...
function historyRouteCreateGraph(e) {
	...
	"speed" == e ? (historyRouteData.graph.units = la.UNIT_SPEED, historyRouteData.graph.result_type = "") : "altitude" == e ? (historyRouteData.graph.units = la.UNIT_HEIGHT, historyRouteData.graph.result_type = "") : "odo" == a.type ? (historyRouteData.graph.units = la.UNIT_DISTANCE, historyRouteData.graph.result_type = a.result_type) : "engh" == a.type ? (historyRouteData.graph.units = la.UNIT_H, historyRouteData.graph.result_type = a.result_type) : (historyRouteData.graph.units = a.units, historyRouteData.graph.result_type = a.result_type),
...
function historyRoutePlay() {
	if (clearTimeout(timer_historyRoutePlay), 0 == historyRouteData.play.status && destroyMapPopup(), historyRouteData.route.length > 0 && historyRouteData.play.position < historyRouteData.route.length) {
		...
		1 == document.getElementById("bottom_panel_graph_play_speed").value ? timer_historyRoutePlay = setTimeout("historyRoutePlay()", 2e3) : 2 == document.getElementById("bottom_panel_graph_play_speed").value ? timer_historyRoutePlay = setTimeout("historyRoutePlay()", 1e3) : 3 == document.getElementById("bottom_panel_graph_play_speed").value ? timer_historyRoutePlay = setTimeout("historyRoutePlay()", 500) : 4 == document.getElementById("bottom_panel_graph_play_speed").value ? timer_historyRoutePlay = setTimeout("historyRoutePlay()", 250) : 5 == document.getElementById("bottom_panel_graph_play_speed").value ? timer_historyRoutePlay = setTimeout("historyRoutePlay()", 125) : 6 == document.getElementById("bottom_panel_graph_play_speed").value && (timer_historyRoutePlay = setTimeout("historyRoutePlay()", 65)),
...
function historyRouteShowPoint(e, t) {
	...
	if (datalistShowData("route", i, c), t) {
		...
		geocoderGetAddress(s, o, function (t) {
			...
			for (var y in h) {
				var v = h[y];
				if ("true" == v.popup) if ("fuelsumup" == v.type) {
			...
			E += "</table>",
			B += "</table>",
			0 == e || historyRouteData.route.length - 1 == e ? addPopupToMap(s, o, [0, -28 * g], E, B) : addPopupToMap(s, o, [0, -14 * g], E, B),
			1 == gsValues.map_street_view && (objectUnSelectAll(), utilsStreetView(s, o, l))
		})
	}
}
...
function historyRouteShowStop(e) {
	...
	geocoderGetAddress(o, i, function (e) {
		...
		1 == gsValues.map_street_view && (objectUnSelectAll(), utilsStreetView(o, i, n))
	})
}
...
function historyRouteShowEvent(e) {
	...
	geocoderGetAddress(n, s, function (e) {
		...
		1 == gsValues.map_street_view && (objectUnSelectAll(), utilsStreetView(n, s, d))
	})
}
...
function reportProperties(e) {
	...
	default:
		...
		reportsSwitchType(),
		document.getElementById("dialog_report_ignore_empty_reports").checked = strToBoolean(reportsData.reports[t].ignore_empty_reports),
		...
		var o = document.getElementById("dialog_report_zone_list"),
	...
	case "add":
		...
		$("#dialog_report_type").multipleSelect("refresh"),
		reportsSwitchType(),
		document.getElementById("dialog_report_ignore_empty_reports").checked = !1,
	...
	case "save":
		...
		h = document.getElementById("dialog_report_stop_duration").value,
		...
		if (("overspeed" == c || "underspeed" == c) && "" == v) return void notifyBox("error", la.ERROR, la.SPEED_LIMIT_CANT_BE_EMPTY);
		if ("" == b) return void notifyBox("error", la.ERROR, la.AT_LEAST_ONE_OBJECT_SELECTED);
		if (("zone_in_out" == c || "zone_in_out_general" == c) && "" == E) return void notifyBox("error", la.ERROR, la.AT_LEAST_ONE_ZONE_SELECTED);
		...
		j = "";
		if (1 == B && (j = "d"), 1 == D && (j += "w"), "" != j) for (var k = O.split(","), T = 0; T < k.length; T++) if (k[T] = k[T].trim(), !isEmailValid(k[T])) return void notifyBox("error", la.ERROR, la.THIS_EMAIL_IS_NOT_VALID);
		var R = {
			cmd: "save_report",
		...
		break;
	case "generate":
		_ = document.getElementById("dialog_report_name").value,
		c = document.getElementById("dialog_report_type").value,
		g = document.getElementById("dialog_report_ignore_empty_reports").checked,
		m = document.getElementById("dialog_report_format").value,
		u = document.getElementById("dialog_report_show_coordinates").checked,
		...
		"" == _ && (_ = document.getElementById("dialog_report_type").options[document.getElementById("dialog_report_type").selectedIndex].text),
		reportGenerate(R = {
			cmd: "report",
			name: _,
			type: c,
...
function reportGenerate(e) {
	"overspeed" != e.type && "underspeed" != e.type && "rag" != e.type && "rag_driver" != e.type || "" != e.speed_limit ? "" != e.imei ? "zone_in_out" != e.type && "zone_in_out_general" != e.type || "" != e.zone_ids ? "drives_stops_sensors" != e.type && "drives_stops_logic" != e.type && "logic_sensors" != e.type && "sensor_graph" != e.type || "" != e.sensor_names ? (loadingData(!0), $.ajax({
		type: "POST",
...
function reportsListSensors() {
	...
	if ("drives_stops_sensors" == t || "drives_stops_logic" == t || "logic_sensors" == t || "sensor_graph" == t) {
		for (var a = document.getElementById("dialog_report_object_list"), i = new Array, o = 0; o < a.options.length; o++) if (a.options[o].selected) {
			var s = a.options[o].value,
			n = settingsObjectData[s].sensors;
			for (var l in n) {
				var d = n[l];
				"string" != d.result_type && ("drives_stops_logic" == t || "logic_sensors" == t ? "logic" == d.result_type && i.push(d.name) : "drives_stops_sensors" != t && "sensor_graph" != t || i.push(d.name))
			}
		}
		i = uniqueArray(i);
...
function reportsSwitchType() {
	...
	case "general_merged":
		...
		document.getElementById("dialog_report_zones_addresses").disabled = !0;
		break;
	case "object_info":
		document.getElementById("dialog_report_zone_list").disabled = !0,
		$("#dialog_report_zone_list option:selected").removeAttr("selected"),
	...
	case "current_position_off":
		...
		document.getElementById("dialog_report_speed_limit").disabled = !0,
		document.getElementById("dialog_report_stop_duration").disabled = !0,
		document.getElementById("dialog_report_show_coordinates").disabled = !1,
		document.getElementById("dialog_report_show_addresses").disabled = !1,
		document.getElementById("dialog_report_zones_addresses").disabled = !1;
		break;
	case "drives_stops":
		document.getElementById("dialog_report_zone_list").disabled = !0,
		$("#dialog_report_zone_list option:selected").removeAttr("selected"),
...
reportsData.data_items.general = ["route_start", "route_end", "route_length", "move_duration", "stop_duration", "stop_count", "top_speed", "avg_speed", "overspeed_count", "fuel_consumption", "avg_fuel_consumption", "fuel_cost", "engine_work", "engine_idle", "odometer", "engine_hours", "driver", "trailer"],
reportsData.data_items.general_merged = ["route_start", "route_end", "route_length", "move_duration", "stop_duration", "stop_count", "top_speed", "avg_speed", "overspeed_count", "fuel_consumption", "avg_fuel_consumption", "fuel_cost", "engine_work", "engine_idle", "odometer", "engine_hours", "driver", "trailer", "total"],
reportsData.data_items.object_info = ["imei", "transport_model", "vin", "plate_number", "odometer", "engine_hours", "driver", "trailer", "gps_device", "sim_card_number"],
reportsData.data_items.current_position = ["time", "position", "speed", "altitude", "angle", "status", "odometer", "engine_hours"],
reportsData.data_items.current_position_off = ["time", "position", "speed", "altitude", "angle", "status", "odometer", "engine_hours"],
reportsData.data_items.drives_stops = ["status", "start", "end", "duration", "move_duration", "stop_duration", "route_length", "top_speed", "avg_speed", "fuel_consumption", "avg_fuel_consumption", "fuel_cost", "engine_work", "engine_idle", "driver", "trailer"],
reportsData.data_items.drives_stops_sensors = ["status", "start", "end", "duration", "move_duration", "stop_duration", "route_length", "top_speed", "avg_speed", "fuel_consumption", "avg_fuel_consumption", "fuel_cost", "engine_work", "engine_idle", "driver", "trailer"],
reportsData.data_items.drives_stops_logic = ["status", "start", "end", "duration", "move_duration", "stop_duration", "route_length", "top_speed", "avg_speed", "fuel_consumption", "avg_fuel_consumption", "fuel_cost", "engine_work", "engine_idle", "driver", "trailer"],
reportsData.data_items.travel_sheet = ["time_a", "position_a", "time_b", "position_b", "duration", "route_length", "fuel_consumption", "avg_fuel_consumption", "fuel_cost", "driver", "trailer", "total"],
reportsData.data_items.travel_sheet_dn = ["time_a", "position_a", "time_b", "position_b", "duration", "route_length", "fuel_consumption", "avg_fuel_consumption", "fuel_cost", "driver", "trailer", "total"],
reportsData.data_items.mileage_daily = ["time", "start", "end", "route_length", "fuel_consumption", "avg_fuel_consumption", "fuel_cost", "engine_hours", "total", "driver", "trailer"],
reportsData.data_items.overspeed = ["start", "end", "duration", "top_speed", "avg_speed", "overspeed_position"],
reportsData.data_items.underspeed = ["start", "end", "duration", "top_speed", "avg_speed", "underspeed_position"],
reportsData.data_items.zone_in_out = ["zone_in", "zone_out", "duration", "route_length", "zone_name", "zone_position", "total"],
reportsData.data_items.zone_in_out_general = ["zone_in", "zone_out", "duration", "route_length", "zone_name", "zone_position", "total"],
reportsData.data_items.events = ["time", "event", "driver", "event_position", "total"],
...
reportsData.data_items.rag_driver = ["overspeed_score", "harsh_acceleration_score", "harsh_braking_score", "harsh_cornering_score"],
reportsData.data_items.tasks = ["name", "description", "from", "start_time", "to", "end_time", "priority", "status"],
reportsData.data_items.rilogbook = ["group", "name", "position"],
reportsData.data_items.dtc = ["code", "position"],
reportsData.data_items.expenses = ["date", "name", "object", "quantity", "cost", "supplier", "buyer", "odometer", "engine_hours", "description", "total"],
reportsData.data_items.logic_sensors = ["sensor", "activation_time", "deactivation_time", "duration", "activation_position", "deactivation_position"],
...
reportsData.data_items.fuelfillings = ["time", "position", "before", "after", "filled", "sensor", "driver", "total"],
reportsData.data_items.fuelthefts = ["time", "position", "before", "after", "stolen", "sensor", "driver", "total"],
reportsData.data_items.temperature_graph = [],
reportsData.data_items.sensor_graph = [],
reportsData.data_items.routes = ["route_start", "route_end", "route_length", "move_duration", "stop_duration", "stop_count", "top_speed", "avg_speed", "overspeed_count", "fuel_consumption", "avg_fuel_consumption", "fuel_cost", "engine_work", "engine_idle", "odometer", "engine_hours", "driver", "trailer"],
reportsData.data_items.routes_stops = ["route_start", "route_end", "route_length", "move_duration", "stop_duration", "stop_count", "top_speed", "avg_speed", "overspeed_count", "fuel_consumption", "avg_fuel_consumption", "fuel_cost", "engine_work", "engine_idle", "odometer", "engine_hours", "driver", "trailer"],
...
function tasksShow() {
	...
	"" != t && (e += "&imei=" + t),
	a != i && (e += "&dtf=" + a + "&dtt=" + i),
	$("#tasks_list_grid").jqGrid("setGridParam", {
		url: e
	}).trigger("reloadGrid")
}
	...
	if (1 != gsValues.map_bussy) {
		...
		map.on("editable:drawing:clicked", function (e) {
			...
			geocoderGetAddress(a[0].lat, a[0].lng, function (e) {
				...
				document.getElementById("dialog_task_start_lat").value = a[0].lat,
				document.getElementById("dialog_task_start_lng").value = a[0].lng
			}),
...
function tasksPickAddress(e) {
	1 != gsValues.map_bussy && (map.doubleClickZoom.disable(), gsValues.map_bussy = !0, document.getElementById("map").style.cursor = "crosshair", $("#dialog_tasks").dialog("close"), $("#dialog_task_properties").dialog("close"), map.on("click", function (t) {
		"start" == e ? geocoderGetAddress(t.latlng.lat, t.latlng.lng, function (e) {
			document.getElementById("dialog_task_start_address").value = e,
			document.getElementById("dialog_task_start_lat").value = t.latlng.lat,
			document.getElementById("dialog_task_start_lng").value = t.latlng.lng
		}) : geocoderGetAddress(t.latlng.lat, t.latlng.lng, function (e) {
			document.getElementById("dialog_task_end_address").value = e,
			document.getElementById("dialog_task_end_lat").value = t.latlng.lat,
			document.getElementById("dialog_task_end_lng").value = t.latlng.lng
		}),
		map.off("click"),
		map.doubleClickZoom.enable(),
		gsValues.map_bussy = !1,
...
function taskProperties(e) {
	...
	default:
		...
		$.ajax({
			...
			success: function (e) {
				...
				document.getElementById("dialog_task_priority").value = e.priority,
				...
				o = e.end_to_dt.split(" ");
				document.getElementById("dialog_task_start_address").value = e.start_address,
				document.getElementById("dialog_task_start_lat").value = e.start_lat,
				document.getElementById("dialog_task_start_lng").value = e.start_lng,
				document.getElementById("dialog_task_start_from_date").value = t[0],
				document.getElementById("dialog_task_start_from_time").value = t[1].substring(0, 5),
				$("#dialog_task_start_from_time").multipleSelect("refresh"),
				document.getElementById("dialog_task_start_to_date").value = a[0],
				document.getElementById("dialog_task_start_to_time").value = a[1].substring(0, 5),
				$("#dialog_task_start_to_time").multipleSelect("refresh"),
				document.getElementById("dialog_task_end_address").value = e.end_address,
				...
				document.getElementById("dialog_task_end_from_time").value = i[1].substring(0, 5),
				$("#dialog_task_end_from_time").multipleSelect("refresh"),
				document.getElementById("dialog_task_end_to_date").value = o[0],
				document.getElementById("dialog_task_end_to_time").value = o[1].substring(0, 5),
	...
	case "add":
		...
		document.getElementById("dialog_task_start_from_date").value = moment().format("YYYY-MM-DD"),
		document.getElementById("dialog_task_start_from_time").value = "00:00",
		$("#dialog_task_start_from_time").multipleSelect("refresh"),
		document.getElementById("dialog_task_start_to_date").value = moment().format("YYYY-MM-DD"),
		...
		document.getElementById("dialog_task_end_from_date").value = moment().format("YYYY-MM-DD"),
		document.getElementById("dialog_task_end_from_time").value = "00:00",
		$("#dialog_task_end_from_time").multipleSelect("refresh"),
		document.getElementById("dialog_task_end_to_date").value = moment().format("YYYY-MM-DD"),
...
function notifyCheck(e) {
	...
	case "expiring_objects":
		if (1 == gsValues.notify_obj_expire) for (var t in settingsObjectData) {
...
function placesGroupLoadData(e) {
	$.ajax({
		...
		cache: !1,
		success: function (t) {
			for (var a in placesGroupData.groups = t, placesGroupData.edit_group_id = !1, initSelectList("places_group_list"), placesGroupData.groups) null != document.getElementById("marker_group_name_" + a) && (document.getElementById("marker_group_name_" + a).innerHTML = placesGroupData.groups[a].name),
			null != document.getElementById("route_group_name_" + a) && (document.getElementById("route_group_name_" + a).innerHTML = placesGroupData.groups[a].name),
			null != document.getElementById("zone_group_name_" + a) && (document.getElementById("zone_group_name_" + a).innerHTML = placesGroupData.groups[a].name);
			e(!0)
		}
	})
}
...
function placesImportPLCFile(e) {
	...
	a.onload = function (e) {
		try {
			...
			i = JSON.stringify(a);
			else if ("csv" == t[0].name.split(".").pop().toLowerCase()) a = placesCSVToPLC(csv2json(e.target.result)),
			i = JSON.stringify(a);
			else a = $.parseJSON(e.target.result),
			i = e.target.result;
			if ("0.1v" == a.plc) {
				...
				confirmDialog(sprintf(la.MARKERS_ROUTES_ZONES_FOUND, o, s, n) + " " + la.ARE_YOU_SURE_YOU_WANT_TO_IMPORT, function (e) {
					if (e) {
						...
						$.ajax({
							...
							success: function (e) {
								loadingData(!1),
								"OK" == e ? (placesMarkerLoadData(), placesRouteLoadData(), placesZoneLoadData(), $("#side_panel_places_marker_list_grid").trigger("reloadGrid"), $("#side_panel_places_route_list_grid").trigger("reloadGrid"), $("#side_panel_places_zone_list_grid").trigger("reloadGrid")) : "ERROR_MARKER_LIMIT" == e ? notifyBox("error", la.ERROR, la.MARKER_LIMIT_IS_REACHED) : "ERROR_ROUTE_LIMIT" == e ? notifyBox("error", la.ERROR, la.ROUTE_LIMIT_IS_REACHED) : "ERROR_ZONE_LIMIT" == e && notifyBox("error", la.ERROR, la.ZONE_LIMIT_IS_REACHED)
							},
							error: function (e, t) {
								loadingData(!1)
							}
...
function placesMarkerLoadData() {
	$.ajax({
		...
		success: function (e) {
			...
			"" != placesMarkerData.markers ? placesMarkerAddAllToMap() : placesMarkerRemoveAllFromMap()
		}
	})
}
...
function placesMarkerAddToMapByClick(e) {
	...
	placesMarkerAddToMap(e.latlng.lat, e.latlng.lng, placesMarkerData.marker_icon)
}
...
function placesMarkerProperties(e) {
	...
	default:
		...
		placesMarkerAddToMap((l = placesMarkerData.markers[t].marker_layer.getLatLng()).lat, l.lng, placesMarkerData.marker_icon),
	...
	case "save":
		...
		$.ajax({
			...
			success: function (e) {
				...
				document.getElementById("map").style.cursor = "",
				$("#dialog_places_marker_properties").dialog("close"),
				"OK" == e ? (placesMarkerLoadData(), $("#side_panel_places_marker_list_grid").trigger("reloadGrid")) : "ERROR_MARKER_LIMIT" == e && notifyBox("error", la.ERROR, la.MARKER_LIMIT_IS_REACHED)
			}
		})
	}
}
	...
	0 == placesMarkerData.default_icons_loaded && $.ajax({
		...
		success: function (e) {
			...
			for (document.getElementById("places_marker_icon_default_list").innerHTML = "", i = 0; i < e.length; i++) {
				...
				t += '<a href="#" onclick="placesMarkerSelectIcon(\'' + a + "');\">",
				t += '<img src="' + a + '" style="padding:5px; width: 32px; height: 32px;"/>',
				t += "</a>",
				t += "</div>"
			}
			t += "</div>",
			document.getElementById("places_marker_icon_default_list").innerHTML = t,
	...
	0 == placesMarkerData.custom_icons_loaded && $.ajax({
		...
		success: function (e) {
			...
			for (document.getElementById("places_marker_icon_custom_list").innerHTML = "", i = 0; i < e.length; i++) {
				...
				t += '<a href="#" onclick="placesMarkerDeleteCustomIcon(\'' + a + "');\">",
			...
			t += "</div>",
			document.getElementById("places_marker_icon_custom_list").innerHTML = t,
...
function placesMarkerVisibleToggle(e) {
	...
	placesMarkerData.markers[e].visible = t,
	placesMarkerVisible(e, t)
}
...
function placesMarkerVisibleAll(e) {
	if (gsValues.map_markers = e, 1 == e) {
		for (var t in placesGroupData.groups) placesGroupData.groups[t].marker_visible = !0,
		placesSetListCheckbox("marker_group_visible_" + t, !0);
		for (var t in placesMarkerData.markers) placesMarkerData.markers[t].visible = !0,
		placesSetListCheckbox("marker_visible_" + t, !0),
		placesMarkerVisible(t, !0)
	} else {
		for (var t in placesGroupData.groups) placesGroupData.groups[t].marker_visible = !1,
		placesSetListCheckbox("marker_group_visible_" + t, !1);
		for (var t in placesMarkerData.markers) placesMarkerData.markers[t].visible = !1,
...
function placesZoneLoadData() {
	$.ajax({
		...
		success: function (e) {
			...
			"" != placesZoneData.zones ? placesZoneAddAllToMap() : placesZoneRemoveAllFromMap()
		}
	})
}
...
function placesZoneAddZoneToMap(e, t, a, i, o, s, n) {
	...
	"false" == o && (t = ""),
	"0" != s && (measure_area = getAreaFromLatLngs(d.getLatLngs()[0]), "1" == s && (measure_area *= 247105e-9, measure_area = Math.round(100 * measure_area) / 100, measure_area = measure_area + " " + la.UNIT_ACRE), "2" == s && (measure_area *= 1e-4, measure_area = Math.round(100 * measure_area) / 100, measure_area = measure_area + " " + la.UNIT_HECTARES), "3" == s && (measure_area = Math.round(100 * measure_area) / 100, measure_area = measure_area + " " + la.UNIT_SQ_M), "4" == s && (measure_area *= 1e-6, measure_area = Math.round(100 * measure_area) / 100, measure_area = measure_area + " " + la.UNIT_SQ_KM), "5" == s && (measure_area *= 10.7639, measure_area = Math.round(100 * measure_area) / 100, measure_area = measure_area + " " + la.UNIT_SQ_FT), "6" == s && (measure_area = 1e-6 * measure_area * .386102, measure_area = Math.round(100 * measure_area) / 100, measure_area = measure_area + " " + la.UNIT_SQ_MI), t = t + " (" + measure_area + ")");
...
function placesZoneNew(e) {
	utilsCheckPrivileges("viewer") && utilsCheckPrivileges("subuser") && 1 != gsValues.map_bussy && (map.doubleClickZoom.disable(), gsValues.map_bussy = !0, document.getElementById("dialog_places_zone_name").value = la.NEW_ZONE + " " + placesZoneData.new_zone_id, document.getElementById("dialog_places_zone_group").value = 0, $("#dialog_places_zone_group").multipleSelect("refresh"), document.getElementById("dialog_places_zone_color").value = "FF0000", document.getElementById("dialog_places_zone_color").style.backgroundColor = "#FF0000", document.getElementById("dialog_places_zone_visible").checked = !0, document.getElementById("dialog_places_zone_name_visible").checked = !0, document.getElementById("dialog_places_zone_area").value = 0, $("#dialog_places_zone_area").multipleSelect("refresh"), $("#dialog_places_zone_properties").dialog("open"), null != e ? map.editTools.startPolygon(e) : map.editTools.startPolygon(), map.on("editable:drawing:end", function (e) {
		...
		placesZoneData.edit_zone_layer.getLatLngs()[0].length < 3 ? placesZoneProperties("cancel") : placesZoneData.edit_zone_layer.getLatLngs()[0].length > 80 ? notifyBox("error", la.ERROR, la.ZONE_CANT_HAVE_MORE_THAN_NUM_VERTICES) : map.off("editable:drawing:end")
	}))
}
...
function placesZoneVerticesStringToLatLngs(e) {
	var t = e.split(","),
	a = [];
	for (j = 0; j < t.length; j += 2) lat = t[j],
	lng = t[j + 1],
	a.push(L.latLng(lat, lng));
	return a
}
function placesZoneProperties(e) {
	...
	case "cancel":
		...
		map.hasLayer(placesZoneData.edit_zone_layer) && map.removeLayer(placesZoneData.edit_zone_layer);
		var o = placesZoneData.zones[placesZoneData.edit_zone_id];
		0 != placesZoneData.edit_zone_id && 1 == o.visible && placesZoneVisible(placesZoneData.edit_zone_id, !0),
	...
	case "save":
		...
		$.ajax({
			...
			success: function (e) {
				...
				map.doubleClickZoom.enable(),
				$("#dialog_places_zone_properties").dialog("close"),
				"OK" == e ? (placesZoneLoadData(), $("#side_panel_places_zone_list_grid").trigger("reloadGrid")) : "ERROR_ZONE_LIMIT" == e && notifyBox("error", la.ERROR, la.ZONE_LIMIT_IS_REACHED)
			}
		})
	}
}
...
function placesZoneVisibleToggle(e) {
	...
	placesZoneData.zones[e].visible = t,
	placesZoneVisible(e, t)
}
...
function placesZoneVisibleAll(e) {
	if (gsValues.map_zones = e, 1 == e) {
		for (var t in placesGroupData.groups) placesGroupData.groups[t].zone_visible = !0,
		placesSetListCheckbox("zone_group_visible_" + t, !0);
		for (var t in placesZoneData.zones) placesZoneData.zones[t].visible = !0,
		placesSetListCheckbox("zone_visible_" + t, !0),
		placesZoneVisible(t, !0)
	} else {
		for (var t in placesGroupData.groups) placesGroupData.groups[t].zone_visible = !1,
		placesSetListCheckbox("zone_group_visible_" + t, !1);
		for (var t in placesZoneData.zones) placesZoneData.zones[t].visible = !1,
...
function placesRouteLoadData() {
	$.ajax({
		...
		success: function (e) {
			...
			"" != placesRouteData.routes ? placesRouteAddAllToMap() : placesRouteRemoveAllFromMap()
		}
	})
}
function placesRouteInitLists() {
	initSelectList("events_route_list"),
...
function placesRouteSave(e) {
	if (utilsCheckPrivileges("viewer") && utilsCheckPrivileges("subuser") && 1 != gsValues.map_bussy) {
		...
		document.getElementById("dialog_places_route_name").value = la.NEW_ROUTE + " " + placesRouteData.new_route_id,
		...
		document.getElementById("dialog_places_route_color").style.backgroundColor = "#FF0000",
...
function placesRouteNew(e) {
	utilsCheckPrivileges("viewer") && utilsCheckPrivileges("subuser") && 1 != gsValues.map_bussy && (map.doubleClickZoom.disable(), gsValues.map_bussy = !0, document.getElementById("dialog_places_route_name").value = la.NEW_ROUTE + " " + placesRouteData.new_route_id, document.getElementById("dialog_places_route_group").value = 0, $("#dialog_places_route_group").multipleSelect("refresh"), document.getElementById("dialog_places_route_color").value = "FF0000", document.getElementById("dialog_places_route_color").style.backgroundColor = "#FF0000", document.getElementById("dialog_places_route_visible").checked = !0, document.getElementById("dialog_places_route_name_visible").checked = !0, document.getElementById("dialog_places_route_deviation").value = "0.5", $("#dialog_places_route_properties").dialog("open"), null != e ? (map.editTools.startPolyline(e), placesRouteData.edit_start_label_layer = L.tooltip({
		...
		map.hasLayer(placesRouteData.edit_start_label_layer) ? placesRouteData.edit_start_label_layer.setLatLng(a) : (placesRouteData.edit_start_label_layer = L.tooltip({
			...
			offset: [10, 0],
			direction: "right"
		}), placesRouteData.edit_start_label_layer.setLatLng(i), placesRouteData.edit_start_label_layer.setContent(la.ROUTE_START), map.addLayer(placesRouteData.edit_start_label_layer)),
		t.length > 1 && (map.hasLayer(placesRouteData.edit_end_label_layer) ? placesRouteData.edit_end_label_layer.setLatLng(i) : (placesRouteData.edit_end_label_layer = L.tooltip({
			permanent: !0,
			offset: [10, 0],
			direction: "right"
...
function placesRouteProperties(e) {
	...
	case "cancel":
		...
		map.editTools.stopDrawing(),
		map.hasLayer(placesRouteData.edit_route_layer) && map.removeLayer(placesRouteData.edit_route_layer),
		map.hasLayer(placesRouteData.edit_start_label_layer) && map.removeLayer(placesRouteData.edit_start_label_layer),
		map.hasLayer(placesRouteData.edit_end_label_layer) && map.removeLayer(placesRouteData.edit_end_label_layer);
		var o = placesRouteData.routes[placesRouteData.edit_route_id];
		0 != placesRouteData.edit_route_id && 1 == o.visible && placesRouteVisible(placesRouteData.edit_route_id, !0),
	...
	case "save":
		...
		$.ajax({
			...
			success: function (e) {
				...
				map.doubleClickZoom.enable(),
				$("#dialog_places_route_properties").dialog("close"),
				"OK" == e ? (placesRouteLoadData(), $("#side_panel_places_route_list_grid").trigger("reloadGrid")) : "ERROR_ROUTE_LIMIT" == e && notifyBox("error", la.ERROR, la.ROUTE_LIMIT_IS_REACHED)
			}
		})
	}
}
...
function placesRouteVisibleToggle(e) {
	...
	placesRouteData.routes[e].visible = t,
	placesRouteVisible(e, t)
}
...
function placesRouteVisibleAll(e) {
	if (gsValues.map_routes = e, 1 == e) {
		for (var t in placesGroupData.groups) placesGroupData.groups[t].route_visible = !0,
		placesSetListCheckbox("route_group_visible_" + t, !0);
		for (var t in placesRouteData.routes) placesRouteData.routes[t].visible = !0,
		placesSetListCheckbox("route_visible_" + t, !0),
		placesRouteVisible(t, !0)
	} else {
		for (var t in placesGroupData.groups) placesGroupData.groups[t].route_visible = !1,
		placesSetListCheckbox("route_group_visible_" + t, !1);
		for (var t in placesRouteData.routes) placesRouteData.routes[t].visible = !1,
...
function settingsEventProperties(e) {
	...
	default:
		...
		document.getElementById("dialog_settings_event_wd_sun").checked = strToBoolean(a[0]),
		...
		document.getElementById("dialog_settings_event_notify_system").checked = strToBoolean(r[0]),
		document.getElementById("dialog_settings_event_notify_system_hide").checked = strToBoolean(r[1]),
		document.getElementById("dialog_settings_event_notify_system_sound").checked = strToBoolean(r[2]),
		null != r[3] && (document.getElementById("dialog_settings_event_notify_system_sound_file").value = r[3], $("#dialog_settings_event_notify_system_sound_file").multipleSelect("refresh")),
		document.getElementById("dialog_settings_event_notify_push").checked = strToBoolean(settingsEventData[t].notify_push),
		...
		$("#dialog_settings_event_notify_email_template").multipleSelect("refresh"),
		document.getElementById("dialog_settings_event_notify_sms_template").value = settingsEventData[t].sms_template_id,
		$("#dialog_settings_event_notify_sms_template").multipleSelect("refresh"),
		...
		$("#dialog_settings_event_notify_arrow_color").multipleSelect("refresh"),
		...
		document.getElementById("dialog_settings_event_webhook_send").checked = strToBoolean(settingsEventData[t].webhook_send),
		document.getElementById("dialog_settings_event_webhook_url").value = settingsEventData[t].webhook_url,
		document.getElementById("dialog_settings_event_cmd_gateway").disabled = !1,
		...
		document.getElementById("dialog_settings_event_cmd_template_list").value = "",
		$("#dialog_settings_event_cmd_template_list").multipleSelect("refresh"),
	...
	case "add":
		...
		$("#dialog_settings_event_object_list option:selected").removeAttr("selected"),
		$("#dialog_settings_event_object_list").multipleSelect("refresh"),
		...
		$("#dialog_settings_event_param_sensor_condition_src").multipleSelect("refresh"),
		document.getElementById("dialog_settings_event_param_sensor_condition_cn").value = "",
		$("#dialog_settings_event_param_sensor_condition_cn").multipleSelect("refresh"),
		...
		document.getElementById("dialog_settings_event_notify_push").checked = !1,
		...
		document.getElementById("dialog_settings_event_webhook_send").checked = !1,
		document.getElementById("dialog_settings_event_webhook_url").value = "",
		document.getElementById("dialog_settings_event_cmd_gateway").disabled = !1,
		document.getElementById("dialog_settings_event_cmd_type").disabled = !1,
	...
	case "save":
		...
		a += String(document.getElementById("dialog_settings_event_wd_mon").checked) + ",",
		...
		if (imei = multiselectGetValues(i), "sos" == _ || "bracon" == _ || "bracoff" == _ || "dismount" == _ || "disassem" == _ || "door" == _ || "mandown" == _ || "shock" == _ || "tow" == _ || "pwrcut" == _ || "gpsantcut" == _ || "jamming" == _ || "lowdc" == _ || "lowbat" == _ || "connyes" == _ || "gpsyes" == _ || "haccel" == _ || "hbrake" == _ || "hcorn" == _ || "driverch" == _ || "trailerch" == _ || "service" == _ || "dtc" == _ || "route_in" == _ || "route_out" == _ || "zone_in" == _ || "zone_out" == _) var y = "";
		if ("connno" == _) {
		...
		if ("overspeed" == _ || "underspeed" == _) if ("" == (y = document.getElementById("dialog_settings_event_speed_limit").value)) {
			notifyBox("error", la.ERROR, la.ALL_AVAILABLE_FIELDS_SHOULD_BE_FILLED_OUT);
			break
		}
		if ("param" == _ || "sensor" == _) {
			var h = settingsEditData.event_condition;
			if (0 == h.length) {
		...
		if ("route_in" != _ || "route_out" != _) {
			var b = document.getElementById("dialog_settings_event_routes");
			if ("route_in" == _ || "route_out" == _) {
				if (v = "off", !multiselectIsSelected(b)) {
					notifyBox("error", la.ERROR, la.AT_LEAST_ONE_ROUTE_SELECTED);
					break
				}
			} else v = document.getElementById("dialog_settings_event_route_trigger").value;
			s = multiselectGetValues(b)
		}
		var E = "";
		l = "";
		if ("route_in" != _ && "route_out" != _) {
		...
		if (B) for (var O = D.split(","), j = 0; j < O.length; j++) if (O[j] = O[j].trim(), !isEmailValid(O[j])) return notifyBox("error", la.ERROR, la.THIS_EMAIL_IS_NOT_VALID),
		!1;
		var k = document.getElementById("dialog_settings_event_notify_sms").checked,
		T = document.getElementById("dialog_settings_event_notify_sms_number").value;
		if (k && "" == T) {
			notifyBox("error", la.ERROR, la.PHONE_CANT_BE_EMPTY);
			break
		}
		var R = document.getElementById("dialog_settings_event_notify_email_template").value,
		...
		if (1 == C) {
			if ("" == G) return notifyBox("error", la.ERROR, la.COMMAND_CANT_BE_EMPTY, !0),
			!1;
			if ("hex" == U && (G = G.toUpperCase(), !isHexValid(G.replace("%IMEI%", "")))) return notifyBox("error", la.ERROR, la.COMMAND_HEX_NOT_VALID, !0),
			!1
		}
		var V = {
			cmd: "save_event",
...
function settingsEventConditionAdd() {
	...
	if ("" != e && "" != t && "" != a) {
		for (var i = 0; i < settingsEditData.event_condition.length; i++) if (settingsEditData.event_condition[i].src == e) return void notifyBox("error", la.ERROR, la.SAME_SOURCE_ITEM_AVAILABLE);
...
function settingsEventConditionDel(e) {
	settingsEditData.event_condition.splice(e, 1),
	settingsEventConditionList()
}
...
function settingsEventSwitchType() {
	...
	case "service":
	case "dtc":
		document.getElementById("dialog_settings_event_time_period").disabled = !0,
		document.getElementById("dialog_settings_event_speed_limit").disabled = !0,
		$("#settings_event_param_sensor_condition_list_grid").closest(".ui-jqgrid").block({
			message: ""
		}),
		document.getElementById("dialog_settings_event_param_sensor_condition_src").disabled = !0,
		document.getElementById("dialog_settings_event_param_sensor_condition_cn").disabled = !0,
		document.getElementById("dialog_settings_event_param_sensor_condition_val").disabled = !0,
		document.getElementById("dialog_settings_event_param_sensor_condition_add").disabled = !0,
		document.getElementById("dialog_settings_event_route_trigger").disabled = !1,
		document.getElementById("dialog_settings_event_zone_trigger").disabled = !1,
		document.getElementById("dialog_settings_event_routes").disabled = !1,
		document.getElementById("dialog_settings_event_zones").disabled = !1;
		break;
	case "connno":
	case "gpsno":
		document.getElementById("dialog_settings_event_time_period").disabled = !1,
		document.getElementById("dialog_settings_event_speed_limit").disabled = !0,
		"" == document.getElementById("dialog_settings_event_time_period").value && (document.getElementById("dialog_settings_event_time_period").value = 60),
		$("#settings_event_param_sensor_condition_list_grid").closest(".ui-jqgrid").block({
			message: ""
		}),
		document.getElementById("dialog_settings_event_param_sensor_condition_src").disabled = !0,
	...
	case "engidle":
		document.getElementById("dialog_settings_event_time_period").disabled = !1,
		document.getElementById("dialog_settings_event_speed_limit").disabled = !0,
		"" == document.getElementById("dialog_settings_event_time_period").value && (document.getElementById("dialog_settings_event_time_period").value = 5),
		$("#settings_event_param_sensor_condition_list_grid").closest(".ui-jqgrid").block({
			message: ""
		}),
		document.getElementById("dialog_settings_event_param_sensor_condition_src").disabled = !0,
	...
	case "underspeed":
		document.getElementById("dialog_settings_event_time_period").disabled = !0,
		document.getElementById("dialog_settings_event_speed_limit").disabled = !1,
		"" == document.getElementById("dialog_settings_event_speed_limit").value && (document.getElementById("dialog_settings_event_speed_limit").value = 60),
		$("#settings_event_param_sensor_condition_list_grid").closest(".ui-jqgrid").block({
			message: ""
		}),
		document.getElementById("dialog_settings_event_param_sensor_condition_src").disabled = !0,
	...
	case "param":
		document.getElementById("dialog_settings_event_time_period").disabled = !0,
		document.getElementById("dialog_settings_event_speed_limit").disabled = !0,
		$("#settings_event_param_sensor_condition_list_grid").closest(".ui-jqgrid").unblock(),
		document.getElementById("dialog_settings_event_param_sensor_condition_src").disabled = !1,
		document.getElementById("dialog_settings_event_param_sensor_condition_cn").disabled = !1,
		document.getElementById("dialog_settings_event_param_sensor_condition_val").disabled = !1,
		document.getElementById("dialog_settings_event_param_sensor_condition_add").disabled = !1,
...
function settingsEventCmdTemplateSwitch() {
	...
	"" != t ? (document.getElementById("dialog_settings_event_cmd_gateway").disabled = !0, document.getElementById("dialog_settings_event_cmd_type").disabled = !0, document.getElementById("dialog_settings_event_cmd_gateway").value = "gprs", document.getElementById("dialog_settings_event_cmd_type").value = "ascii", "" != a && (t = t + "," + a), document.getElementById("dialog_settings_event_cmd_string").value = t) : "" != e ? (document.getElementById("dialog_settings_event_cmd_gateway").disabled = !1, document.getElementById("dialog_settings_event_cmd_type").disabled = !1, document.getElementById("dialog_settings_event_cmd_gateway").value = cmdData.cmd_templates[e].gateway, document.getElementById("dialog_settings_event_cmd_type").value = cmdData.cmd_templates[e].type, document.getElementById("dialog_settings_event_cmd_string").value = cmdData.cmd_templates[e].cmd) : (document.getElementById("dialog_settings_event_cmd_gateway").disabled = !1, document.getElementById("dialog_settings_event_cmd_type").disabled = !1, document.getElementById("dialog_settings_event_cmd_gateway").value = "gprs", document.getElementById("dialog_settings_event_cmd_type").value = "ascii", document.getElementById("dialog_settings_event_cmd_string").value = ""),
	$("#dialog_settings_event_cmd_gateway").multipleSelect("refresh"),
	$("#dialog_settings_event_cmd_type").multipleSelect("refresh")
}
...
function settingsObjectGroupProperties(e) {
	...
	case "add":
		...
		$("#dialog_settings_object_group_objects option:selected").removeAttr("selected"),
		$("#dialog_settings_object_group_objects").multipleSelect("refresh"),
		$("#dialog_settings_object_group_properties").dialog("open");
		break;
	case "cancel":
	...
	case "save":
		...
		var d = l.split(",");
		for (var o in settingsObjectData) for (var r = 0; r < d.length; r++) o == d[r] && (settingsObjectData[o].group_id = settingsEditData.group_id);
		var _ = {
...
function settingsObjectDriverProperties(e) {
	...
	case "add":
		...
		settingsEditData.driver_img_file = !1,
		(a = document.getElementById("dialog_settings_object_driver_photo")).src = "img/user-blank.svg",
		...
		if (t[0].type.match("image/png") || t[0].type.match("image/jpeg")) {
			...
			i.onload = function () {
				i.width > 640 || i.height > 480 ? notifyBox("error", la.ERROR, la.IMAGE_SIZE_SHOULD_NOT_BE_BIGGER_THAN_640_480) : $.ajax({
					...
					contentType: !1,
					success: function (e) {
						document.getElementById("dialog_settings_object_driver_photo").src = e + "?t=" + (new Date).getTime(),
...
function settingsObjectPassengerImportOPAFile(e) {
	...
	a.readAsText(t[0], "UTF-8"),
	this.removeEventListener("change", settingsObjectPassengerImportOPAFile, !1)
}
...
function settingsObjectPassengerProperties(e) {
	...
	default:
		...
		$.ajax({
			...
			cache: !1,
			success: function (e) {
				settingsEditData.passenger_id = t,
				document.getElementById("dialog_settings_object_passenger_name").value = e.name,
				document.getElementById("dialog_settings_object_passenger_assign_id").value = e.assign_id,
				document.getElementById("dialog_settings_object_passenger_idn").value = e.idn,
				document.getElementById("dialog_settings_object_passenger_address").value = e.address,
				document.getElementById("dialog_settings_object_passenger_phone").value = e.phone,
				document.getElementById("dialog_settings_object_passenger_email").value = e.email,
				document.getElementById("dialog_settings_object_passenger_desc").value = e.desc,
...
function settingsObjectTrailerImportOTRFile(e) {
	...
	a.readAsText(t[0], "UTF-8"),
	this.removeEventListener("change", settingsObjectTrailerImportOTRFile, !1)
}
...
function loadSettings(e, t) {
	...
	case "cookies":
		...
		null == a && (a = guiDragbars.objects + ";" + guiDragbars.events + ";" + guiDragbars.history + ";" + guiDragbars.bottom_panel),
		null != (a = a.split(";"))[0] && "" != a[0] && (guiDragbars.objects = a[0]),
		...
		null == i && (i = gsValues.map_lat + ";" + gsValues.map_lng + ";" + gsValues.map_zoom + ";" + gsValues.map_layer + ";", i += gsValues.map_objects + ";" + gsValues.map_object_labels + ";" + gsValues.map_markers + ";" + gsValues.map_routes + ";" + gsValues.map_zones + ";" + gsValues.map_clusters + ";" + gsValues.map_kml),
		i = i.split(";"),
		"last" == settingsUserData.map_sp && (null != i[0] && "" != i[0] && (gsValues.map_lat = i[0]), null != i[1] && "" != i[1] && (gsValues.map_lng = i[1]), null != i[2] && "" != i[2] && (gsValues.map_zoom = i[2])),
		null != i[3] && "" != i[3] && (gsValues.map_layer = i[3]),
		null != i[4] && "" != i[4] && (gsValues.map_objects = strToBoolean(i[4])),
		null != i[5] && "" != i[5] && (gsValues.map_object_labels = strToBoolean(i[5])),
		null != i[6] && "" != i[6] && (gsValues.map_markers = strToBoolean(i[6])),
		null != i[7] && "" != i[7] && (gsValues.map_routes = strToBoolean(i[7])),
		null != i[8] && "" != i[8] && (gsValues.map_zones = strToBoolean(i[8])),
		null != i[9] && "" != i[9] && (gsValues.map_clusters = strToBoolean(i[9])),
		null != i[10] && "" != i[10] && (gsValues.map_kml = strToBoolean(i[10])),
		t(!0);
		break;
	case "server":
		var o = {
		...
		$.ajax({
			...
			success: function (e) {
				...
				gsValues.map_google_street_view = strToBoolean(e.map_google_street_view),
				...
				gsValues.address_display_object_data_list = strToBoolean(e.address_display_object_data_list),
				gsValues.address_display_event_data_list = strToBoolean(e.address_display_event_data_list),
				gsValues.address_display_history_route_data_list = strToBoolean(e.address_display_history_route_data_list),
				gsValues.notify_obj_expire = strToBoolean(e.notify_obj_expire),
				gsValues.notify_obj_expire_period = e.notify_obj_expire_period,
				gsValues.notify_account_expire = strToBoolean(e.notify_account_expire),
				gsValues.notify_account_expire_period = e.notify_account_expire_period,
				t(!0)
			}
		});
		break;
		...
		$.ajax({
			...
			success: function (e) {
				...
				if (document.getElementById("settings_main_ohc_stopped").checked = settingsUserData.ohc.stopped, document.getElementById("settings_main_ohc_stopped_color").value = settingsUserData.ohc.stopped_color.substr(1), document.getElementById("settings_main_ohc_stopped_color").style.backgroundColor = settingsUserData.ohc.stopped_color, document.getElementById("settings_main_ohc_moving").checked = settingsUserData.ohc.moving, document.getElementById("settings_main_ohc_moving_color").value = settingsUserData.ohc.moving_color.substr(1), document.getElementById("settings_main_ohc_moving_color").style.backgroundColor = settingsUserData.ohc.moving_color, document.getElementById("settings_main_ohc_engine_idle").checked = settingsUserData.ohc.engine_idle, document.getElementById("settings_main_ohc_engine_idle_color").value = settingsUserData.ohc.engine_idle_color.substr(1), document.getElementById("settings_main_ohc_engine_idle_color").style.backgroundColor = settingsUserData.ohc.engine_idle_color, document.getElementById("settings_main_language").value = settingsUserData.language, document.getElementById("system_language").value = settingsUserData.language, document.getElementById("settings_main_distance_unit").value = settingsUserData.unit_distance, document.getElementById("settings_main_capacity_unit").value = settingsUserData.unit_capacity, document.getElementById("settings_main_temperature_unit").value = settingsUserData.unit_temperature, document.getElementById("settings_main_currency").value = settingsUserData.currency, document.getElementById("settings_main_timezone").value = settingsUserData.timezone, 11 == settingsUserData.dst_start.length && 11 == settingsUserData.dst_end.length) {
					...
					document.getElementById("settings_main_dst_start_mmdd").value = o[0],
					document.getElementById("settings_main_dst_start_hhmm").value = o[1];
					var s = settingsUserData.dst_end.split(" ");
					document.getElementById("settings_main_dst_end_mmdd").value = s[0],
					document.getElementById("settings_main_dst_end_hhmm").value = s[1]
				} else document.getElementById("settings_main_dst").checked = !1,
				...
				document.getElementById("settings_main_name_surname").value = n.name,
				document.getElementById("settings_main_company").value = n.company,
				document.getElementById("settings_main_address").value = n.address,
				document.getElementById("settings_main_post_code").value = n.post_code,
				document.getElementById("settings_main_city").value = n.city,
				document.getElementById("settings_main_country").value = n.country,
				...
				document.getElementById("settings_main_usage_email_daily").innerHTML = settingsUserData.usage_email_daily_cnt + "/" + settingsUserData.usage_email_daily,
				document.getElementById("settings_main_usage_sms_daily").innerHTML = settingsUserData.usage_sms_daily_cnt + "/" + settingsUserData.usage_sms_daily,
				document.getElementById("settings_main_usage_webhook_daily").innerHTML = settingsUserData.usage_webhook_daily_cnt + "/" + settingsUserData.usage_webhook_daily,
				document.getElementById("settings_main_usage_api_daily").innerHTML = settingsUserData.usage_api_daily_cnt + "/" + settingsUserData.usage_api_daily,
				settingsCheck(),
				t(!0)
			}
		});
...
function settingsSave() {
	if (utilsCheckPrivileges("viewer")) {
		...
		v += "," + document.getElementById("settings_main_temperature_unit").value;
		...
		j = document.getElementById("settings_main_new_password").value,
		k = document.getElementById("settings_main_new_password_rep").value;
		if (O.length > 0) {
			if (j.length < 6) return void notifyBox("error", la.ERROR, la.PASSWORD_LENGHT_AT_LEAST);
			if ( - 1 != j.indexOf(" ")) return void notifyBox("error", la.ERROR, la.PASSWORD_SPACE_CHARACTERS);
			if (j != k) return void notifyBox("error", la.ERROR, la.REPEATED_PASSWORD_IS_INCORRECT)
		}
		var T = {
...
function settingsSaveCookies() {
	...
	if (setCookie("gs_dragbars", e, 30), null != map && map.getZoom() && map.getCenter() && map.getCenter()) {
		...
		t += gsValues.map_objects + ";" + gsValues.map_object_labels + ";" + gsValues.map_markers + ";" + gsValues.map_routes + ";" + gsValues.map_zones + ";" + gsValues.map_clusters + ";" + gsValues.map_kml,
		setCookie("gs_map", t, 30)
	}
}
...
function settingsObjectDuplicate(e) {
	...
	default:
		var t = e;
		settingsEditData.object_duplicate_imei = t,
...
function settingsObjectEdit(e) {
	...
	default:
		...
		null == settingsObjectGroupData[a] ? document.getElementById("dialog_settings_object_edit_group").value = 0 : document.getElementById("dialog_settings_object_edit_group").value = settingsObjectData[t].group_id,
		$("#dialog_settings_object_edit_group").multipleSelect("refresh");
		var i = settingsObjectData[t].driver_id;
		null == settingsObjectDriverData[i] ? document.getElementById("dialog_settings_object_edit_driver").value = 0 : document.getElementById("dialog_settings_object_edit_driver").value = settingsObjectData[t].driver_id,
		$("#dialog_settings_object_edit_driver").multipleSelect("refresh");
		var o = settingsObjectData[t].trailer_id;
		null == settingsObjectTrailerData[o] ? document.getElementById("dialog_settings_object_edit_trailer").value = 0 : document.getElementById("dialog_settings_object_edit_trailer").value = settingsObjectData[t].trailer_id,
		$("#dialog_settings_object_edit_trailer").multipleSelect("refresh"),
		...
		document.getElementById("dialog_settings_object_edit_arrow_no_connection").value = s.arrow_no_connection,
		$("#dialog_settings_object_edit_arrow_no_connection").multipleSelect("refresh"),
		document.getElementById("dialog_settings_object_edit_arrow_stopped").value = s.arrow_stopped,
		$("#dialog_settings_object_edit_arrow_stopped").multipleSelect("refresh"),
		document.getElementById("dialog_settings_object_edit_arrow_moving").value = s.arrow_moving,
		$("#dialog_settings_object_edit_arrow_moving").multipleSelect("refresh"),
		document.getElementById("dialog_settings_object_edit_arrow_engine_idle").value = s.arrow_engine_idle,
		$("#dialog_settings_object_edit_arrow_engine_idle").multipleSelect("refresh"),
		document.getElementById("dialog_settings_object_edit_map_icon").value = settingsObjectData[t].map_icon,
		$("#dialog_settings_object_edit_map_icon").multipleSelect("refresh"),
		...
		$("#dialog_settings_object_edit_fcr_source").multipleSelect("refresh"),
		document.getElementById("dialog_settings_object_edit_fcr_measurement").value = settingsObjectData[t].fcr.measurement,
		$("#dialog_settings_object_edit_fcr_measurement").multipleSelect("refresh"),
		...
		$("#settings_object_accuracy_time_adj").multipleSelect("refresh"),
		document.getElementById("settings_object_accuracy_detect_stops").value = settingsObjectData[t].accuracy.stops,
		$("#settings_object_accuracy_detect_stops").multipleSelect("refresh"),
		document.getElementById("settings_object_accuracy_route_length").value = settingsObjectData[t].accuracy.route_length,
		$("#settings_object_accuracy_route_length").multipleSelect("refresh"),
		...
		document.getElementById("settings_object_accuracy_accvirt").checked = strToBoolean(settingsObjectData[t].accvirt),
		document.getElementById("dialog_settings_object_edit_odometer_type").value = settingsObjectData[t].odometer_type,
		$("#dialog_settings_object_edit_odometer_type").multipleSelect("refresh"),
		document.getElementById("dialog_settings_object_edit_engine_hours_type").value = settingsObjectData[t].engine_hours_type,
		$("#dialog_settings_object_edit_engine_hours_type").multipleSelect("refresh"),
	...
	case "save":
		if (!utilsCheckPrivileges("viewer")) return;
		a = document.getElementById("dialog_settings_object_edit_group").value,
		i = document.getElementById("dialog_settings_object_edit_driver").value,
		...
		v = JSON.stringify(v);
		var b = document.getElementById("settings_object_accuracy_accvirt").checked,
		E = settingsEditData.object_accvirt_cn,
		f = document.getElementById("dialog_settings_object_edit_odometer_type").value,
		I = document.getElementById("dialog_settings_object_edit_engine_hours_type").value,
		B = document.getElementById("dialog_settings_object_edit_odometer").value,
		D = document.getElementById("dialog_settings_object_edit_engine_hours").value;
		if (B == settingsEditData.odometer && (B = !1), D == settingsEditData.engine_hours && (D = !1), "" == n) {
			notifyBox("error", la.ERROR, la.NAME_CANT_BE_EMPTY);
			break
		}
		var O = {
...
function settingsObjectEditSelectDefaultIcon(e) {
	settingsEditData.object_icon = e,
	document.getElementById("dialog_settings_object_edit_icon").innerHTML = '<img src="' + e + '" />',
	...
	0 == settingsEditData.default_icons_loaded && $.ajax({
		...
		success: function (e) {
			...
			for (document.getElementById("settings_object_edit_select_icon_default_list").innerHTML = "", i = 0; i < e.length; i++) {
				...
				t += '<div class="icon-object-edit">',
				t += '<a href="#" onclick="settingsObjectEditSelectDefaultIcon(\'' + a + "');\">",
				t += '<img src="' + a + '" style="padding:5px; width: 32px; height: 32px;"/>',
				t += "</a>",
				t += "</div>"
			}
			t += "</div>",
			document.getElementById("settings_object_edit_select_icon_default_list").innerHTML = t,
			settingsEditData.default_icons_loaded = !0
		}
	})
}
	...
	0 == settingsEditData.custom_icons_loaded && $.ajax({
		...
		success: function (e) {
			...
			for (document.getElementById("settings_object_edit_select_icon_custom_list").innerHTML = "", i = 0; i < e.length; i++) {
				...
				t += '<div class="icon-object-edit">',
				t += '<a href="#" onclick="settingsObjectEditSelectCustomIcon(\'' + a + "');\">",
				t += '<img src="' + a + '" style="padding:5px; width: 32px; height: 32px;"/>',
				t += "</a>",
				t += '<div class="icon-custom-delete">',
				t += '<a href="#" onclick="settingsObjectEditDeleteCustomIcon(\'' + a + "');\">",
				t += '<img border="0" src="theme/images/remove.svg" width="8px">',
				t += "</a>",
				t += "</div>",
				t += "</div>"
			...
			t += "</div>",
			document.getElementById("settings_object_edit_select_icon_custom_list").innerHTML = t,
			settingsEditData.custom_icons_loaded = !0
		}
	})
}
...
function settingsObjectEditUploadCustomIconFile(e) {
		...
		if ("image/png" == t[0].type || "image/svg+xml" == t[0].type) {
			...
			i.onload = function () {
				...
				$.ajax({
					...
					contentType: !1,
					success: function (e) {
						settingsEditData.custom_icons_loaded = !1,
						settingsObjectEditLoadCustomIconList()
					}
				})
			},
	...
	a.readAsDataURL(t[0]),
	this.removeEventListener("change", settingsObjectEditUploadCustomIconFile, !1)
}
...
function settingsObjectEditAccvirt(e) {
	if (utilsCheckPrivileges("subuser") && utilsCheckPrivileges("obj_edit")) {
		...
		case "open":
			...
			a.options.length = 0;
			for (var i = getObjectParamsArray(t), o = 0; o < i.length; o++) a.options.add(new Option(i[o], i[o]));
			document.getElementById("dialog_settings_object_edit_accvirt_param").value = settingsObjectData[t].accvirt_cn.param,
			$("#dialog_settings_object_edit_accvirt_param").multipleSelect("refresh"),
			document.getElementById("dialog_settings_object_edit_accvirt_1_cn").value = settingsObjectData[t].accvirt_cn.accvirt_1_cn,
			$("#dialog_settings_object_edit_accvirt_1_cn").multipleSelect("refresh"),
			document.getElementById("dialog_settings_object_edit_accvirt_0_cn").value = settingsObjectData[t].accvirt_cn.accvirt_0_cn,
			$("#dialog_settings_object_edit_accvirt_0_cn").multipleSelect("refresh"),
			document.getElementById("dialog_settings_object_edit_accvirt_1_val").value = settingsObjectData[t].accvirt_cn.accvirt_1_val,
			document.getElementById("dialog_settings_object_edit_accvirt_0_val").value = settingsObjectData[t].accvirt_cn.accvirt_0_val,
			$("#dialog_settings_object_edit_accvirt").dialog("open");
			break;
		case "save":
			...
			settingsEditData.object_accvirt_cn = JSON.stringify(_),
...
function settingsObjectSensorImportSENFile(e) {
	...
	a.readAsText(t[0], "UTF-8"),
	this.removeEventListener("change", settingsObjectSensorImportSENFile, !1)
}
...
function settingsObjectSensorProperties(cmd) {
	var imei = settingsEditData.object_imei;
	switch (cmd) {
	default:
		var id = cmd;
		settingsEditData.sensor_id = id;
		var select = document.getElementById("dialog_settings_object_sensor_param");
		select.options.length = 0;
		for (var params = getObjectParamsArray(imei), i = 0; i < params.length; i++) select.options.add(new Option(params[i], params[i]));
		document.getElementById("dialog_settings_object_sensor_type").value = settingsObjectData[imei].sensors[id].type,
		$("#dialog_settings_object_sensor_type").multipleSelect("refresh"),
		settingsObjectSensorType(),
		document.getElementById("dialog_settings_object_sensor_result_type").value = settingsObjectData[imei].sensors[id].result_type,
		$("#dialog_settings_object_sensor_result_type").multipleSelect("refresh"),
		settingsObjectSensorResultType(),
		document.getElementById("dialog_settings_object_sensor_name").value = settingsObjectData[imei].sensors[id].name,
		document.getElementById("dialog_settings_object_sensor_param").value = settingsObjectData[imei].sensors[id].param,
		$("#dialog_settings_object_sensor_param").multipleSelect("refresh"),
		document.getElementById("dialog_settings_object_sensor_units").value = settingsObjectData[imei].sensors[id].units,
		document.getElementById("dialog_settings_object_sensor_text_1").value = settingsObjectData[imei].sensors[id].text_1,
		document.getElementById("dialog_settings_object_sensor_text_0").value = settingsObjectData[imei].sensors[id].text_0;
		var result_type = settingsObjectData[imei].sensors[id].result_type;
		"abs" == result_type || "rel" == result_type ? (document.getElementById("dialog_settings_object_sensor_data_list").checked = !1, document.getElementById("dialog_settings_object_sensor_popup").checked = !1) : (document.getElementById("dialog_settings_object_sensor_data_list").checked = strToBoolean(settingsObjectData[imei].sensors[id].data_list), document.getElementById("dialog_settings_object_sensor_popup").checked = strToBoolean(settingsObjectData[imei].sensors[id].popup)),
		"value" != result_type && "accum" != result_type && "abs" != result_type && "rel" != result_type || (document.getElementById("dialog_settings_object_sensor_formula").value = settingsObjectData[imei].sensors[id].formula),
		"percentage" == result_type ? (document.getElementById("dialog_settings_object_sensor_lv").value = settingsObjectData[imei].sensors[id].lv, document.getElementById("dialog_settings_object_sensor_hv").value = settingsObjectData[imei].sensors[id].hv) : (document.getElementById("dialog_settings_object_sensor_lv").value = "", document.getElementById("dialog_settings_object_sensor_hv").value = ""),
		"acc" == settingsObjectData[imei].sensors[id].type ? document.getElementById("dialog_settings_object_sensor_acc_ignore").checked = !1 : document.getElementById("dialog_settings_object_sensor_acc_ignore").checked = strToBoolean(settingsObjectData[imei].sensors[id].acc_ignore),
		...
		settingsEditData.sensor_calibration = settingsObjectData[imei].sensors[id].calibration.slice(0),
		settingsObjectSensorCalibrationList(),
		document.getElementById("settings_object_sensor_dictionary_value").value = "",
		document.getElementById("settings_object_sensor_dictionary_text").value = "",
		settingsEditData.sensor_dictionary = settingsObjectData[imei].sensors[id].dictionary.slice(0),
		...
		break;
	case "add":
		if (settingsEditData.sensor_id = !1, "" != settingsObjectData[imei].params) {
			var select = document.getElementById("dialog_settings_object_sensor_param");
			select.options.length = 0;
			for (var params = getObjectParamsArray(imei), i = 0; i < params.length; i++) select.options.add(new Option(params[i], params[i]));
			document.getElementById("dialog_settings_object_sensor_type").value = "batt",
			$("#dialog_settings_object_sensor_type").multipleSelect("refresh"),
			settingsObjectSensorType(),
			document.getElementById("dialog_settings_object_sensor_result_type").value = "value",
			$("#dialog_settings_object_sensor_result_type").multipleSelect("refresh"),
			settingsObjectSensorResultType(),
			document.getElementById("dialog_settings_object_sensor_name").value = "",
			document.getElementById("dialog_settings_object_sensor_param").value = "",
			$("#dialog_settings_object_sensor_param").multipleSelect("refresh"),
			document.getElementById("dialog_settings_object_sensor_data_list").checked = !0,
			document.getElementById("dialog_settings_object_sensor_popup").checked = !1,
	...
	case "save":
		if (!utilsCheckPrivileges("viewer")) return;
		var name = document.getElementById("dialog_settings_object_sensor_name").value,
		...
		result_type = document.getElementById("dialog_settings_object_sensor_result_type").value,
		...
		if (("" == name || "" == param) && "abs" == result_type) {
			notifyBox("error", la.ERROR, la.ALL_AVAILABLE_FIELDS_SHOULD_BE_FILLED_OUT);
			break
		}
		if (("" == name || "" == param) && "rel" == result_type) {
			notifyBox("error", la.ERROR, la.ALL_AVAILABLE_FIELDS_SHOULD_BE_FILLED_OUT);
			break
		}
		if (("" == name || "" == param || "" == text_1 || "" == text_0) && "logic" == result_type) {
			notifyBox("error", la.ERROR, la.ALL_AVAILABLE_FIELDS_SHOULD_BE_FILLED_OUT);
			break
		}
		if (("" == name || "" == param) && "value" == result_type) {
			notifyBox("error", la.ERROR, la.ALL_AVAILABLE_FIELDS_SHOULD_BE_FILLED_OUT);
			break
		}
		if (("" == name || "" == param) && "string" == result_type) {
			notifyBox("error", la.ERROR, la.ALL_AVAILABLE_FIELDS_SHOULD_BE_FILLED_OUT);
			break
		}
		if (("" == name || "" == param || "" == lv || "" == hv) && "percentage" == result_type) {
			notifyBox("error", la.ERROR, la.ALL_AVAILABLE_FIELDS_SHOULD_BE_FILLED_OUT);
			break
		}
		if ("" != formula) {
                formula = formula.toLowerCase();//, formula = formula.replace(/[^-()\d/*+.x]/g, ""); //10/10/2020 Se comento la linea para que no omitiera esos caracteres
                var k = formula.replace("x", "1");
				k = k.split('pow').join('Math.pow')
				k = k.split('asin').join('Math.asin')
				k = k.split('acos').join('Math.acos')
				k = k.split('sqrt').join('Math.sqrt')
				k = k.split('round').join('Math.round')
				k = k.split('x').join('1')
                try {
                    eval(k)
                } catch (e) {
                    if (e instanceof SyntaxError) {
                        notifyBox("error", "1", la.FORMULA_IS_NOT);
                        break
                    }
                    notifyBox("error", e , k);
                    break
...
function settingsObjectSensorCalibrationAdd() {
	...
	isNumber(e) || (e = 0),
	isNumber(t) || (t = 0);
	for (var a = 0; a < settingsEditData.sensor_calibration.length; a++) if (settingsEditData.sensor_calibration[a].x == e) return void notifyBox("error", la.ERROR, la.VALUE_IS_ALREADY_AVAILABLE);
...
function settingsObjectSensorDictionaryAdd() {
	...
	isNumber(e) || (e = 0);
	for (var a = 0; a < settingsEditData.sensor_dictionary.length; a++) if (settingsEditData.sensor_dictionary[a].value == e) return void notifyBox("error", la.ERROR, la.VALUE_IS_ALREADY_AVAILABLE);
...
function settingsObjectSensorType() {
	...
	case "batt":
		document.getElementById("dialog_settings_object_sensor_param").disabled = !1,
		document.getElementById("dialog_settings_object_sensor_data_list").disabled = !1,
		document.getElementById("dialog_settings_object_sensor_popup").disabled = !1,
		document.getElementById("dialog_settings_object_sensor_result_type").disabled = !1,
		document.getElementById("dialog_settings_object_sensor_acc_ignore").disabled = !1,
		t.options.add(new Option(la.VALUE, "value")),
		t.options.add(new Option("Percentage", "percentage"));
		break;
	case "di":
	case "do":
		document.getElementById("dialog_settings_object_sensor_param").disabled = !1,
		...
		document.getElementById("dialog_settings_object_sensor_result_type").disabled = !1,
		document.getElementById("dialog_settings_object_sensor_acc_ignore").disabled = !1,
		t.options.add(new Option(la.LOGIC, "logic"));
		break;
	case "da":
		document.getElementById("dialog_settings_object_sensor_param").disabled = !1,
		document.getElementById("dialog_settings_object_sensor_data_list").disabled = !0,
		document.getElementById("dialog_settings_object_sensor_data_list").checked = !1,
		document.getElementById("dialog_settings_object_sensor_popup").disabled = !0,
		document.getElementById("dialog_settings_object_sensor_popup").checked = !1,
		document.getElementById("dialog_settings_object_sensor_result_type").disabled = !1,
		document.getElementById("dialog_settings_object_sensor_acc_ignore").disabled = !0,
		document.getElementById("dialog_settings_object_sensor_acc_ignore").checked = !1,
		t.options.add(new Option(la.STRING, "string"));
		break;
	case "engh":
		document.getElementById("dialog_settings_object_sensor_param").disabled = !1,
		document.getElementById("dialog_settings_object_sensor_data_list").disabled = !0,
		...
		document.getElementById("dialog_settings_object_sensor_acc_ignore").disabled = !0,
		document.getElementById("dialog_settings_object_sensor_acc_ignore").checked = !1,
		t.options.add(new Option(la.ABSOLUTE, "abs")),
		t.options.add(new Option(la.RELATIVE, "rel"));
		break;
	case "fuel":
		document.getElementById("dialog_settings_object_sensor_param").disabled = !1,
		document.getElementById("dialog_settings_object_sensor_data_list").disabled = !1,
	...
	case "fuelsumup":
		...
		document.getElementById("dialog_settings_object_sensor_data_list").disabled = !1,
		document.getElementById("dialog_settings_object_sensor_popup").disabled = !1,
		document.getElementById("dialog_settings_object_sensor_result_type").disabled = !0,
		document.getElementById("dialog_settings_object_sensor_acc_ignore").disabled = !0,
		document.getElementById("dialog_settings_object_sensor_acc_ignore").checked = !1;
		break;
	case "fuelcons":
	...
	case "cust":
		...
		t.options.add(new Option(la.VALUE, "value")),
		t.options.add(new Option(la.STRING, "string")),
		t.options.add(new Option(la.PERCENTAGE, "percentage"))
	}
	settingsObjectSensorResultType()
}
function settingsObjectSensorResultType() {
	...
	case "":
		document.getElementById("dialog_settings_object_sensor_units").disabled = !1,
		document.getElementById("dialog_settings_object_sensor_text_1").disabled = !0,
		...
		document.getElementById("settings_object_sensor_calibration_x").disabled = !0,
		document.getElementById("settings_object_sensor_calibration_y").disabled = !0,
		document.getElementById("settings_object_sensor_calibration_add").disabled = !0,
		$("#settings_object_sensor_dictionary_list_grid").closest(".ui-jqgrid").block({
			message: ""
		}),
		document.getElementById("settings_object_sensor_dictionary_value").disabled = !0,
		document.getElementById("settings_object_sensor_dictionary_text").disabled = !0,
		document.getElementById("settings_object_sensor_dictionary_add").disabled = !0;
		break;
	case "abs":
	case "rel":
		document.getElementById("dialog_settings_object_sensor_units").disabled = !0,
		document.getElementById("dialog_settings_object_sensor_text_1").disabled = !0,
		document.getElementById("dialog_settings_object_sensor_text_0").disabled = !0,
		document.getElementById("dialog_settings_object_sensor_lv").disabled = !0,
		document.getElementById("dialog_settings_object_sensor_hv").disabled = !0,
		document.getElementById("dialog_settings_object_sensor_formula").disabled = !1,
		$("#settings_object_sensor_calibration_list_grid").closest(".ui-jqgrid").block({
			message: ""
		}),
		document.getElementById("settings_object_sensor_calibration_x").disabled = !0,
	...
	case "logic":
		document.getElementById("dialog_settings_object_sensor_units").disabled = !0,
		document.getElementById("dialog_settings_object_sensor_text_1").disabled = !1,
		document.getElementById("dialog_settings_object_sensor_text_0").disabled = !1,
		document.getElementById("dialog_settings_object_sensor_lv").disabled = !0,
		document.getElementById("dialog_settings_object_sensor_hv").disabled = !0,
		document.getElementById("dialog_settings_object_sensor_formula").disabled = !0,
		$("#settings_object_sensor_calibration_list_grid").closest(".ui-jqgrid").block({
	...
	case "value":
		...
		document.getElementById("dialog_settings_object_sensor_hv").disabled = !0,
		document.getElementById("dialog_settings_object_sensor_formula").disabled = !1,
		$("#settings_object_sensor_calibration_list_grid").closest(".ui-jqgrid").unblock(),
		document.getElementById("settings_object_sensor_calibration_x").disabled = !1,
		document.getElementById("settings_object_sensor_calibration_y").disabled = !1,
		document.getElementById("settings_object_sensor_calibration_add").disabled = !1,
	...
	case "string":
		...
		break;
	case "percentage":
		document.getElementById("dialog_settings_object_sensor_units").value = "%",
		document.getElementById("dialog_settings_object_sensor_units").disabled = !0,
		document.getElementById("dialog_settings_object_sensor_text_1").disabled = !0,
		document.getElementById("dialog_settings_object_sensor_text_0").disabled = !0,
		document.getElementById("dialog_settings_object_sensor_lv").disabled = !1,
		document.getElementById("dialog_settings_object_sensor_hv").disabled = !1,
		document.getElementById("dialog_settings_object_sensor_formula").disabled = !0,
		$("#settings_object_sensor_calibration_list_grid").closest(".ui-jqgrid").block({
			message: ""
		}),
...
function settingsObjectServiceImportSERFile(e) {
	...
	a.readAsText(t[0], "UTF-8"),
	this.removeEventListener("change", settingsObjectServiceImportSERFile, !1)
}
...
function settingsObjectCustomFieldImportCFLFile(e) {
	...
	a.readAsText(t[0], "UTF-8"),
	this.removeEventListener("change", settingsObjectCustomFieldImportCFLFile, !1)
}
...
function settingsObjectCustomFieldProperties(e) {
	...
	default:
		var a = e;
		settingsEditData.custom_field_id = a,
...
function settingsTemplateImportTEMFile(e) {
	...
	a.readAsText(t[0], "UTF-8"),
	this.removeEventListener("change", settingsTemplateImportTEMFile, !1)
}
function settingsTemplateProperties(e) {
	switch (e) {
	default:
		var t = e;
		settingsEditData.template_id = t,
...
function settingsKMLUploadFile(e) {
	...
	a.readAsDataURL(t[0]),
	this.removeEventListener("change", settingsKMLUploadFile, !1)
}
function settingsKMLProperties(e) {
	switch (e) {
	default:
		var t = e;
		settingsEditData.kml_id = t,
		settingsEditData.kml_file = new Array,
		document.getElementById("dialog_settings_kml_active").checked = strToBoolean(settingsKMLData[t].active),
		document.getElementById("dialog_settings_kml_name").value = settingsKMLData[t].name,
		document.getElementById("dialog_settings_kml_desc").value = settingsKMLData[t].desc,
		document.getElementById("dialog_settings_kml_file").value = settingsKMLData[t].file_name,
		document.getElementById("dialog_settings_kml_upload").disabled = !0,
		$("#dialog_settings_kml_properties").dialog("open");
		break;
	case "add":
		settingsEditData.kml_id = !1,
		settingsEditData.kml_file = new Array,
		document.getElementById("dialog_settings_kml_active").checked = !0,
		document.getElementById("dialog_settings_kml_name").value = "",
		document.getElementById("dialog_settings_kml_desc").value = "",
		document.getElementById("dialog_settings_kml_file").value = "",
		document.getElementById("dialog_settings_kml_upload").disabled = !1,
		$("#dialog_settings_kml_properties").dialog("open");
		break;
	case "cancel":
...
function settingsSubaccountProperties(e) {
	...
	default:
		var t = e;
		settingsEditData.subaccount_id = t,
		document.getElementById("dialog_settings_subaccount_active").checked = strToBoolean(settingsSubaccountData[t].active),
		document.getElementById("dialog_settings_subaccount_username").value = settingsSubaccountData[t].username,
		...
		document.getElementById("dialog_settings_subaccount_send").checked = !1;
		var a = strToBoolean(settingsSubaccountData[t].account_expire);
		document.getElementById("dialog_settings_subaccount_expire_dt").checked = a,
		document.getElementById("dialog_settings_subaccount_expire_dt").value = 1 == a ? settingsSubaccountData[t].account_expire_dt: "",
		document.getElementById("dialog_settings_subaccount_dashboard").checked = settingsSubaccountData[t].dashboard,
		...
		document.getElementById("dialog_settings_subaccount_tachograph").checked = settingsSubaccountData[t].tachograph,
		document.getElementById("dialog_settings_subaccount_tasks").checked = settingsSubaccountData[t].tasks,
		...
		document.getElementById("dialog_settings_subaccount_maintenance").checked = settingsSubaccountData[t].maintenance,
		document.getElementById("dialog_settings_subaccount_expenses").checked = settingsSubaccountData[t].expenses,
		...
		$("#dialog_settings_subaccount_available_zones").multipleSelect("refresh"),
	...
	case "add":
		...
		document.getElementById("dialog_settings_subaccount_username").value = "",
		document.getElementById("dialog_settings_subaccount_email").value = "",
		document.getElementById("dialog_settings_subaccount_password").value = "",
		document.getElementById("dialog_settings_subaccount_send").checked = !0,
		...
		document.getElementById("dialog_settings_subaccount_dashboard").checked = !1,
		...
		document.getElementById("dialog_settings_subaccount_tachograph").checked = !1,
		document.getElementById("dialog_settings_subaccount_tasks").checked = !1,
		...
		document.getElementById("dialog_settings_subaccount_maintenance").checked = !1,
		document.getElementById("dialog_settings_subaccount_expenses").checked = !1,
...
settingsEditData.object_icon = !1,
settingsEditData.object_imei = !1,
settingsEditData.object_duplicate_imei = !1,
settingsEditData.object_accvirt_cn = !1,
settingsEditData.sensor_id = !1,
settingsEditData.sensor_calibration = new Array,
settingsEditData.sensor_dictionary = new Array,
settingsEditData.service_id = !1,
settingsEditData.custom_field_id = !1,
settingsEditData.group_id = !1,
settingsEditData.driver_id = !1,
...
settingsEditData.trailer_id = !1,
settingsEditData.event_id = !1,
settingsEditData.event_condition = new Array,
settingsEditData.template_id = !1,
settingsEditData.kml_id = !1,
settingsEditData.kml_file = new Array,
settingsEditData.subaccount_id = !1,
settingsEditData.subaccount_au = !1,
settingsEditData.default_icons_loaded = !1,
settingsEditData.custom_icons_loaded = !1,
gsValues.title = document.title,
...
gsValues.datalist_groups_colapsed.object = new Array,
gsValues.datalist_groups_colapsed.event = new Array,
gsValues.datalist_groups_colapsed.route = new Array,
gsValues.datalist_first_show = !0;
var la = [],
map,
mapPopup,
...
guiDragbars.objects = 180,
guiDragbars.events = 180,
guiDragbars.history = 180,
guiDragbars.bottom_panel = 178;
var isIE = eval("/*@cc_on!@*/!1");
function load() {
	if (isIE) {
		return '<div class="row">Please use one of these browsers:</div>',
...
function objectLoadData() {
	...
	$.ajax({
		...
		success: function (e) {
			...
			objectUpdateList(),
			objectAddAllToMap(),
			"fit" == settingsUserData.map_sp && 0 == gsValues.map_fit_objects_finished && (fitObjectsOnMap(), gsValues.map_fit_objects_finished = !0),
			objectFollow(),
...
function objectUpdateList() {
	for (var e in objectsData) {
		if ("" != objectsData[e].data) {
			if (null != document.getElementById("object_status_" + e)) {
				document.getElementById("object_visible_" + e).checked = objectsData[e].visible,
				document.getElementById("object_follow_" + e).checked = objectsData[e].follow;
				var t = objectsData[e].status_string;
				"server" == settingsUserData.od ? document.getElementById("object_status_" + e).innerHTML = objectsData[e].data[0].dt_server: "status" == settingsUserData.od && "" != t ? document.getElementById("object_status_" + e).innerHTML = t: document.getElementById("object_status_" + e).innerHTML = objectsData[e].data[0].dt_tracker,
				document.getElementById("object_speed_" + e).innerHTML = objectsData[e].data[0].speed + " " + la.UNIT_SPEED;
	...
	for (var i in settingsObjectGroupData) null != document.getElementById("object_group_visible_" + i) && (document.getElementById("object_group_visible_" + i).checked = settingsObjectGroupData[i].visible),
	null != document.getElementById("object_group_follow_" + i) && (document.getElementById("object_group_follow_" + i).checked = settingsObjectGroupData[i].follow)
}
...
function objectSetStatusEvent(e, t, a) {
	if (null != objectsData[e]) if (0 == t && 0 == a) {
...
function objectAddToMap(e) {
	...
	u.on("click", function (_) {
		objectSelect(e),
		"" != objectsData[e].data && geocoderGetAddress(a, i, function (_) {
			var c = _,
			g = urlPosition(a, i),
			m = "",
			u = "",
			...
			for (var h in v) {
				var b = v[h];
				if ("true" == b.popup) if ("fuelsumup" == b.type) {
			...
			var j = "<table>\t\t\t\t\t<tr><td><strong>" + la.OBJECT + ":</strong></td><td>" + t + "</td></tr>\t\t\t\t\t<tr><td><strong>" + la.ADDRESS + ":</strong></td><td>" + c + "</td></tr>\t\t\t\t\t<tr><td><strong>" + la.POSITION + ":</strong></td><td>" + g + "</td></tr>\t\t\t\t\t<tr><td><strong>" + la.ALTITUDE + ":</strong></td><td>" + o + " " + la.UNIT_HEIGHT + "</td></tr>\t\t\t\t\t<tr><td><strong>" + la.ANGLE + ":</strong></td><td>" + s + " &deg;</td></tr>\t\t\t\t\t<tr><td><strong>" + la.SPEED + ":</strong></td><td>" + n + " " + la.UNIT_SPEED + "</td></tr>\t\t\t\t\t<tr><td><strong>" + la.TIME + ":</strong></td><td>" + l + "</td></tr>",
			k = getObjectOdometer(e, !1); - 1 != k && (j += "<tr><td><strong>" + la.ODOMETER + ":</strong></td><td>" + k + " " + la.UNIT_DISTANCE + "</td></tr>");
			var T = getObjectEngineHours(e, !1); - 1 != T && (j += "<tr><td><strong>" + la.ENGINE_HOURS + ":</strong></td><td>" + T + "</td></tr>");
			var R = j + u + m + p;
			addPopupToMap(a, i, [0, -14 * r], j += "</table>", R += "</table>")
		})
	}),
	u.on("add", function (t) {
...
function objectAddTailToMap(e) {
	if (settingsObjectData[e].tail_points > 0) {
		...
		mapLayers.realtime.addLayer(s),
		objectsData[e].layers.tail = s
	}
}
...
function objectVisibleAll(e) {
	for (var t in gsValues.objects_visible = e, objectsData) objectsData[t].visible = e,
	null != document.getElementById("object_visible_" + t) && (document.getElementById("object_visible_" + t).checked = e),
	objectVisible(t);
...
function objectFollow() {
	...
	t = 0,
	a = new Array;
	for (var i in objectsData) if (strMatches(settingsObjectData[i].name, e) && "" != objectsData[i].data && 1 == objectsData[i].follow) {
...
function objectFollowAll(e) {
	for (var t in gsValues.objects_follow = e, objectsData) objectsData[t].follow = e,
	null != document.getElementById("object_follow_" + t) && (document.getElementById("object_follow_" + t).checked = e);
...
function utilsCheckPrivileges(e) {
	switch (e) {
	case "viewer":
		if (("" == settingsUserData.privileges || "viewer" == settingsUserData.privileges) && 0 == settingsUserData.cpanel_privileges) return notifyBox("error", la.ERROR, la.THIS_ACCOUNT_HAS_NO_PRIVILEGES_TO_DO_THAT),
		!1;
		break;
	case "subuser":
		if ("subuser" == settingsUserData.privileges) return notifyBox("error", la.ERROR, la.THIS_ACCOUNT_HAS_NO_PRIVILEGES_TO_DO_THAT),
		!1;
		break;
	case "obj_add":
		if (0 != settingsUserData.manager_id || "false" == settingsUserData.obj_add) return notifyBox("error", la.ERROR, la.THIS_ACCOUNT_HAS_NO_PRIVILEGES_TO_DO_THAT),
		!1;
		break;
	case "obj_edit":
		if ("true" != settingsUserData.obj_edit) return notifyBox("error", la.ERROR, la.THIS_ACCOUNT_HAS_NO_PRIVILEGES_TO_DO_THAT),
		!1;
		break;
	case "obj_delete":
		if ("true" != settingsUserData.obj_delete) return notifyBox("error", la.ERROR, la.THIS_ACCOUNT_HAS_NO_PRIVILEGES_TO_DO_THAT),
		!1;
		break;
	case "obj_history_clear":
		if ("true" != settingsUserData.obj_history_clear) return notifyBox("error", la.ERROR, la.THIS_ACCOUNT_HAS_NO_PRIVILEGES_TO_DO_THAT),
		!1;
		break;
	case "dashboard":
		if (1 != settingsUserData.privileges_dashboard) return notifyBox("error", la.ERROR, la.THIS_ACCOUNT_HAS_NO_PRIVILEGES_TO_DO_THAT),
		!1;
		break;
	case "history":
		if (1 != settingsUserData.privileges_history) return notifyBox("error", la.ERROR, la.THIS_ACCOUNT_HAS_NO_PRIVILEGES_TO_DO_THAT),
		!1;
		break;
	case "reports":
		if (1 != settingsUserData.privileges_reports) return notifyBox("error", la.ERROR, la.THIS_ACCOUNT_HAS_NO_PRIVILEGES_TO_DO_THAT),
		!1;
		break;
	case "tachograph":
		if (1 != settingsUserData.privileges_tachograph) return notifyBox("error", la.ERROR, la.THIS_ACCOUNT_HAS_NO_PRIVILEGES_TO_DO_THAT),
		!1;
		break;
	case "tasks":
		if (1 != settingsUserData.privileges_tasks) return notifyBox("error", la.ERROR, la.THIS_ACCOUNT_HAS_NO_PRIVILEGES_TO_DO_THAT),
		!1;
		break;
	case "rilogbook":
		if (1 != settingsUserData.privileges_rilogbook) return notifyBox("error", la.ERROR, la.THIS_ACCOUNT_HAS_NO_PRIVILEGES_TO_DO_THAT),
		!1;
		break;
	case "dtc":
		if (1 != settingsUserData.privileges_dtc) return notifyBox("error", la.ERROR, la.THIS_ACCOUNT_HAS_NO_PRIVILEGES_TO_DO_THAT),
		!1;
		break;
	case "maintenance":
		if (1 != settingsUserData.privileges_maintenance) return notifyBox("error", la.ERROR, la.THIS_ACCOUNT_HAS_NO_PRIVILEGES_TO_DO_THAT),
		!1;
		break;
	case "expenses":
		if (1 != settingsUserData.privileges_expenses) return notifyBox("error", la.ERROR, la.THIS_ACCOUNT_HAS_NO_PRIVILEGES_TO_DO_THAT),
		!1;
		break;
	case "object_control":
		if (1 != settingsUserData.privileges_object_control) return notifyBox("error", la.ERROR, la.THIS_ACCOUNT_HAS_NO_PRIVILEGES_TO_DO_THAT),
		!1;
		break;
	case "image_gallery":
		if (1 != settingsUserData.privileges_image_gallery) return notifyBox("error", la.ERROR, la.THIS_ACCOUNT_HAS_NO_PRIVILEGES_TO_DO_THAT),
		!1;
		break;
	case "chat":
		if (1 != settingsUserData.privileges_chat) return notifyBox("error", la.ERROR, la.THIS_ACCOUNT_HAS_NO_PRIVILEGES_TO_DO_THAT),
		!1;
		break;
	case "subaccounts":
		if (1 != settingsUserData.privileges_subaccounts) return notifyBox("error", la.ERROR, la.THIS_ACCOUNT_HAS_NO_PRIVILEGES_TO_DO_THAT),
		!1
	}
	return ! 0
}
...
function utilsRuler() {
	0 == utilsRulerData.enabled ? 1 != gsValues.map_bussy && (utilsRulerData.line_layer = map.editTools.startPolyline(), map.on("editable:editing editable:drag", function (e) {
		...
		if (map.hasLayer(utilsRulerData.label_layer)) {
			...
			i = (i = convDistanceUnits(i, "km", settingsUserData.unit_distance)).toFixed(2),
			i += " " + la.UNIT_DISTANCE,
...
function utilsShowDriverInfo(e) {
	...
	l = '<center><img style="border:0px; width: 80px;" src="' + (l = "" == l ? "img/user-blank.svg": "data/user/drivers/" + l) + '" /></center>',
	text = '<div class="row">',
	text += '<div class="row2"><div class="width40">' + l + '</div><div class="width60">' + t + "</div></div>",
	"" != a && (text += '<div class="row2"><div class="width40"><strong>' + la.ID_NUMBER + ':</strong></div><div class="width60">' + a + "</div></div>"),
	"" != i && (text += '<div class="row2"><div class="width40"><strong>' + la.ADDRESS + ':</strong></div><div class="width60">' + i + "</div></div>"),
	"" != o && (text += '<div class="row2"><div class="width40"><strong>' + la.PHONE + ':</strong></div><div class="width60">' + o + "</div></div>"),
	"" != s && (s = '<a href="mailto:' + s + '">' + s + "</a>", text += '<div class="row2"><div class="width40"><strong>' + la.EMAIL + ':</strong></div><div class="width60">' + s + "</div></div>"),
	"" != n && (text += '<div class="row2"><div class="width40"><strong>' + la.DESCRIPTION + ':</strong></div><div class="width60">' + n + "</div></div>"),
	text += "</div>",
...
function utilsShowTrailerInfo(e) {
	...
	text = '<div class="row">',
	text += '<div class="row2"><div class="width40"><strong>' + la.NAME + ':</strong></div><div class="width60">' + t + "</div></div>",
	"" != a && (text += '<div class="row2"><div class="width40"><strong>' + la.MODEL + ':</strong></div><div class="width60">' + a + "</div></div>"),
	"" != i && (text += '<div class="row2"><div class="width40"><strong>' + la.VIN + ':</strong></div><div class="width60">' + i + "</div></div>"),
	"" != o && (text += '<div class="row2"><div class="width40"><strong>' + la.PLATE_NUMBER + ':</strong></div><div class="width60">' + o + "</div></div>"),
	"" != s && (text += '<div class="row2"><div class="width40"><strong>' + la.DESCRIPTION + ':</strong></div><div class="width60">' + s + "</div></div>"),
	text += "</div>",
...
function utilsSearchAddress() {
	...
	geocoderGetLocation(e, function (t) {
		if (null != t[0]) {
			...
			i = t[0].lng,
			o = urlPosition(a, i);
			addPopupToMap(a, i, [0, 0], "<table>\t\t\t\t\t<tr><td><strong>" + la.ADDRESS + ":</strong></td><td>" + e + "&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>\t\t\t\t\t<tr><td><strong>" + la.POSITION + ":</strong></td><td>" + o + "</td></tr>\t\t\t\t\t</table>", ""),
			map.panTo({
				lat: a,
				lng: i
			}),
...
function utilsFollowObject(e, t) {
	if ("" != objectsData[e].data) {
		...
		if (1 == t) window.open(i, "_blank");
			...
			o += '<iframe src="' + i + '" style="border: 0px; width: 100%; height: 100%;"></iframe>',
			o += "</div>";
...
function utilsRouteToPoint(e) {
	if (1 != gsValues.map_bussy) {
		...
		var t = !1;
		for (var a in objectsData) if (1 == objectsData[a].selected) {
			t = a;
			break
		}
	...
	o.on("routeselected", function (e) {
		...
		d.on("click", function (e) {
			geocoderGetAddress(n, l, function (e) {
				...
				d += '<div style="width:100%; text-align: right;"><a href="#" class="" onClick="utilsRouteBetweenPointsSave();">' + la.SAVE_AS_ROUTE + "</a> " + la.OR,
				d += ' <a href="#" class="" onClick="utilsRouteBetweenPointsHide();">' + la.HIDE.toLowerCase() + "</a></div>",
		...
		(d = L.marker([r, _], {
			...
			geocoderGetAddress(r, _, function (e) {
				...
				n += '<div style="width:100%; text-align: right;"><a href="#" class="" onClick="utilsRouteBetweenPointsSave();">' + la.SAVE_AS_ROUTE + "</a> " + la.OR,
				n += ' <a href="#" class="" onClick="utilsRouteBetweenPointsHide();">' + la.HIDE.toLowerCase() + "</a></div>",
